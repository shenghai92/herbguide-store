...
const rawBasicsArticles: ContentArticle[] = [
...

  {
    ...
    "title": "What Does “Stomach Yin Deficiency” Mean in Traditional Food Writing?",
    "description": "A plain-English guide to Stomach Yin Deficiency in traditional food writing: a three-part label built from Stomach, Yin, and Deficiency, read as a phrase to translate rather than a modern category.",
    "eyebrow": "Basics & Concepts",
    "intro": "“Stomach Yin Deficiency” is a traditional three-part label built from Stomach, Yin, and Deficiency. It is part of a classical system of food language and is best understood as a phrase to translate, not a modern category for a reader. Readers get the most value from the phrase when they separate its words, notice its setting, and then return to the concrete details of food: ingredient form, aroma, flavor, texture, and preparation.",
    "sections": [
      {
        "title": "Start with the phrase, not a personal label",
        "paragraphs": [
      ...
      },
      {
        "title": "Break the wording into its parts",
        "paragraphs": [
          "In this traditional vocabulary, **Stomach** is a traditional network word associated with food, transformation, and receiving in classical writing. The word gains its full sense from the words around it, the type of text, and the recipe or ingredient description in which it appears.",
          "In this traditional vocabulary, **Yin** is a traditional contrast word often used beside yang, moisture, and quietness. The word gains its full sense from the words around it, the type of text, and the recipe or ingredient description in which it appears.",
          "In this traditional vocabulary, **Deficiency** is a contrast word that signals “less than” in a traditional text. The word gains its full sense from the words around it, the type of text, and the recipe or ingredient description in which it appears.",
          "When these words appear together, they create a layered expression. The goal is not to flatten that expression into a single modern word. The goal is to understand why a traditional writer selected these words rather than another nearby phrase."
        ]
      },
      {
        ...
        "bullets": [
          "Stomach — A traditional network word associated with food, transformation, and receiving in classical writing — Read it as a word in a historical food-writing system, then look at ingredient form and recipe context",
          "Yin — A traditional contrast word often used beside yang, moisture, and quietness — Read it as a word in a historical food-writing system, then look at ingredient form and recipe context",
          "Deficiency — A contrast word that signals “less than” in a traditional text — Read it as a word in a historical food-writing system, then look at ingredient form and recipe context",
          "Surrounding words — The nearby vocabulary often changes the emphasis — Read the full phrase before drawing a kitchen connection",
          "Surrounding words — The nearby vocabulary often changes the emphasis — Read the full phrase before drawing a kitchen connection"
        ]
      },
      {
        "title": "Put the phrase back into kitchen context",
        "paragraphs": [
          "The clearest way to keep a traditional phrase grounded is to picture an actual kitchen scene. Think of a clear pear-and-lily bowl with a soft texture and a restrained fragrance. This kind of image does not prove a single translation. Instead, it gives the reader a practical way to remember that classical vocabulary often moves between food, season, appearance, and preparation.",
          "On a recipe page, begin with the ingredients before the label. Notice whether the writer is using fresh or dried material, whether the method is a quick steep or a long simmer, and whether the recipe is built around aroma, flavor, color, or texture. Those concrete details are more useful than trying to make one phrase carry every meaning on its own."
        ]
      },
      {
        "title": "Notice the contrast words around it",
        "paragraphs": [
          "Traditional vocabulary often works through contrast. “Stomach Yin Deficiency” becomes easier to read beside moistening language and Four Natures vocabulary. This does not mean the terms are opposites in every sentence. It means the surrounding language helps readers understand what the writer is emphasizing.",
          "A good reading habit is to put two related pages side by side and underline the words that change. Look for changes in ingredient form, cooking method, season, aroma, and the traditional quality words placed next to an ingredient. This turns an unfamiliar phrase into a map of relationships rather than a memorization task."
        ]
      },
      {
        "title": "Ingredient form is part of the meaning",
        "paragraphs": [
          "Texture matters: a crisp fruit, a softened grain, and a long-cooked soup create different culinary impressions. Traditional writing often pays close attention to those differences. A page about a root, flower, berry, peel, grain, or mushroom may use related vocabulary while still making a different culinary point.",
          "For that reason, do not collapse all ingredient forms into one generic entry. Let a recipe name the form it needs. Then use the flavor and preparation method to understand why that form was chosen. This approach is concrete, repeatable, and easier for English-language readers to carry from one page to the next."
        ]
      },
      {
        "title": "A useful way to take notes",
        "paragraphs": [
          "When you meet a new traditional phrase, record three things: the exact phrase, the ingredient or recipe beside it, and the kitchen image it brings to mind. For “Stomach Yin Deficiency,” the nearby idea to compare is **What Does Yin and Yang Mean? and What Does Moisten Dryness Mean?**. A short note written in your own words is more valuable than copying a long definition.",
          "Over time, these notes reveal patterns. Some words stay close to season and climate imagery. Some are often placed beside flavor or ingredient form. Others help a reader follow how a classical text groups foods and herbs. The pattern becomes clearer through comparison, not through one isolated page."
        ]
      },
      {
    ...
    "references": [
      "HerbGuide. What Is Stomach Yin Deficiency?. https://herbguide.store/basics/what-is-stomach-yin-deficiency/",
      "Chinese Text Project. Huangdi Neijing. https://ctext.org/huangdi-neijing",
      "U.S. Food and Drug Administration. Questions & Answers on Improving the Safety of Spices. https://www.fda.gov/food/risk-and-safety-assessments-food/questions-answers-improving-safety-spices"
    ]
  },

  {
    ...
    "title": "What Does “Lung Yin Deficiency” Mean in Traditional Food Writing?",
    "description": "A plain-English guide to Lung Yin Deficiency in traditional food writing: a phrase composed of Lung, Yin, and Deficiency from a historical vocabulary system.",
    "eyebrow": "Basics & Concepts",
    "intro": "“Lung Yin Deficiency” is a traditional phrase composed of Lung, Yin, and Deficiency. It appears in a historical vocabulary system whose organ words and contrast terms do not map one-to-one to modern language. Readers get the most value from the phrase when they separate its words, notice its setting, and then return to the concrete details of food: ingredient form, aroma, flavor, texture, and preparation.",
    "sections": [
      {
        "title": "Start with the phrase, not a personal label",
        "paragraphs": [
      ...
      },
      {
        "title": "Break the wording into its parts",
        "paragraphs": [
          "In this traditional vocabulary, **Lung** is a traditional network word that has a broader role than an anatomical label. The word gains its full sense from the words around it, the type of text, and the recipe or ingredient description in which it appears.",
          "In this traditional vocabulary, **Yin** is a traditional contrast word often paired with yang and quiet, cooling imagery. The word gains its full sense from the words around it, the type of text, and the recipe or ingredient description in which it appears.",
          "In this traditional vocabulary, **Deficiency** is a contrast word that signals “less than” in a traditional text. The word gains its full sense from the words around it, the type of text, and the recipe or ingredient description in which it appears.",
          "When these words appear together, they create a layered expression. The goal is not to flatten that expression into a single modern word. The goal is to understand why a traditional writer selected these words rather than another nearby phrase."
        ]
      },
      {
        ...
        "bullets": [
          "Lung — A traditional network word that has a broader role than an anatomical label — Read it as a word in a historical food-writing system, then look at ingredient form and recipe context",
          "Yin — A traditional contrast word often paired with yang and quiet, cooling imagery — Read it as a word in a historical food-writing system, then look at ingredient form and recipe context",
          "Deficiency — A contrast word that signals “less than” in a traditional text — Read it as a word in a historical food-writing system, then look at ingredient form and recipe context",
          "Surrounding words — The nearby vocabulary often changes the emphasis — Read the full phrase before drawing a kitchen connection",
          "Surrounding words — The nearby vocabulary often changes the emphasis — Read the full phrase before drawing a kitchen connection"
        ]
      },
      {
        "title": "Put the phrase back into kitchen context",
        "paragraphs": [
          "The clearest way to keep a traditional phrase grounded is to picture an actual kitchen scene. Think of a clear, pale-colored tea with floral aroma rather than a dense roasted brew. This kind of image does not prove a single translation. Instead, it gives the reader a practical way to remember that classical vocabulary often moves between food, season, appearance, and preparation.",
          "On a recipe page, begin with the ingredients before the label. Notice whether the writer is using fresh or dried material, whether the method is a quick steep or a long simmer, and whether the recipe is built around aroma, flavor, color, or texture. Those concrete details are more useful than trying to make one phrase carry every meaning on its own."
        ]
      },
      {
        "title": "Notice the contrast words around it",
        "paragraphs": [
          "Traditional vocabulary often works through contrast. “Lung Yin Deficiency” becomes easier to read beside Lung Qi and Yin–Yang language. This does not mean the terms are opposites in every sentence. It means the surrounding language helps readers understand what the writer is emphasizing.",
          "A good reading habit is to put two related pages side by side and underline the words that change. Look for changes in ingredient form, cooking method, season, aroma, and the traditional quality words placed next to an ingredient. This turns an unfamiliar phrase into a map of relationships rather than a memorization task."
        ]
      },
      {
        "title": "Ingredient form is part of the meaning",
        "paragraphs": [
          "The form of an ingredient—flower, fruit, sliced root, or peel—changes the reader’s expectation of aroma and texture. Traditional writing often pays close attention to those differences. A page about a root, flower, berry, peel, grain, or mushroom may use related vocabulary while still making a different culinary point.",
          "For that reason, do not collapse all ingredient forms into one generic entry. Let a recipe name the form it needs. Then use the flavor and preparation method to understand why that form was chosen. This approach is concrete, repeatable, and easier for English-language readers to carry from one page to the next."
        ]
      },
      {
        "title": "A useful way to take notes",
        "paragraphs": [
          "When you meet a new traditional phrase, record three things: the exact phrase, the ingredient or recipe beside it, and the kitchen image it brings to mind. For “Lung Yin Deficiency,” the nearby idea to compare is **What Is Lung Qi? and What Is Yin and Yang?**. A short note written in your own words is more valuable than copying a long definition.",
          "Over time, these notes reveal patterns. Some words stay close to season and climate imagery. Some are often placed beside flavor or ingredient form. Others help a reader follow how a classical text groups foods and herbs. The pattern becomes clearer through comparison, not through one isolated page."
        ]
      },
      {
    ...
    "references": [
      "HerbGuide. What Is Lung Yin Deficiency?. https://herbguide.store/basics/what-is-lung-yin-deficiency/",
      "Chinese Text Project. Huangdi Neijing. https://ctext.org/huangdi-neijing",
      "U.S. Food and Drug Administration. Questions & Answers on Improving the Safety of Spices. https://www.fda.gov/food/risk-and-safety-assessments-food/questions-answers-improving-safety-spices"
    ]
  },

  {
    ...
    "title": "What Does “Kidney Yang Deficiency” Mean in Traditional Food Writing?",
    "description": "A plain-English guide to Kidney Yang Deficiency in traditional food writing: a compact phrase made of Kidney, Yang, and Deficiency from a historical system.",
    "eyebrow": "Basics & Concepts",
    "intro": "“Kidney Yang Deficiency” is a traditional phrase made of Kidney, Yang, and Deficiency. It is a compact expression from a historical system of food and herb writing, not a modern statement about an individual. Readers get the most value from the phrase when they separate its words, notice its setting, and then return to the concrete details of food: ingredient form, aroma, flavor, texture, and preparation.",
    "sections": [
      {
        "title": "Start with the phrase, not a personal label",
        "paragraphs": [
      ...
      },
      {
        "title": "Break the wording into its parts",
        "paragraphs": [
          "In this traditional vocabulary, **Kidney** is a traditional network word with a meaning broader than an anatomical organ. The word gains its full sense from the words around it, the type of text, and the recipe or ingredient description in which it appears.",
          "In this traditional vocabulary, **Yang** is a contrast word used in classical writing to describe activity, warmth, and outward movement. The word gains its full sense from the words around it, the type of text, and the recipe or ingredient description in which it appears.",
          "In this traditional vocabulary, **Deficiency** is a contrast word that signals “less than” in a traditional text. The word gains its full sense from the words around it, the type of text, and the recipe or ingredient description in which it appears.",
          "When these words appear together, they create a layered expression. The goal is not to flatten that expression into a single modern word. The goal is to understand why a traditional writer selected these words rather than another nearby phrase."
        ]
      },
      {
        ...
        "bullets": [
          "Kidney — A traditional network word with a meaning broader than an anatomical organ — Read it as a word in a historical food-writing system, then look at ingredient form and recipe context",
          "Yang — A contrast word used in classical writing to describe activity, warmth, and outward movement — Read it as a word in a historical food-writing system, then look at ingredient form and recipe context",
          "Deficiency — A contrast word that signals “less than” in a traditional text — Read it as a word in a historical food-writing system, then look at ingredient form and recipe context",
          "Surrounding words — The nearby vocabulary often changes the emphasis — Read the full phrase before drawing a kitchen connection",
          "Surrounding words — The nearby vocabulary often changes the emphasis — Read the full phrase before drawing a kitchen connection"
        ]
      },
      {
        "title": "Put the phrase back into kitchen context",
        "paragraphs": [
          "The clearest way to keep a traditional phrase grounded is to picture an actual kitchen scene. Think of a slow-simmered grain bowl with roasted notes and a warm, deep aroma. This kind of image does not prove a single translation. Instead, it gives the reader a practical way to remember that classical vocabulary often moves between food, season, appearance, and preparation.",
          "On a recipe page, begin with the ingredients before the label. Notice whether the writer is using fresh or dried material, whether the method is a quick steep or a long simmer, and whether the recipe is built around aroma, flavor, color, or texture. Those concrete details are more useful than trying to make one phrase carry every meaning on its own."
        ]
      },
      {
        "title": "Notice the contrast words around it",
        "paragraphs": [
          "Traditional vocabulary often works through contrast. “Kidney Yang Deficiency” becomes easier to read beside Kidney Yin Deficiency and warming food language. This does not mean the terms are opposites in every sentence. It means the surrounding language helps readers understand what the writer is emphasizing.",
          "A good reading habit is to put two related pages side by side and underline the words that change. Look for changes in ingredient form, cooking method, season, aroma, and the traditional quality words placed next to an ingredient. This turns an unfamiliar phrase into a map of relationships rather than a memorization task."
        ]
      },
      {
        "title": "Ingredient form is part of the meaning",
        "paragraphs": [
          "Roasting, drying, and slow simmering create distinct kitchen roles; an ingredient name alone does not tell the whole story. Traditional writing often pays close attention to those differences. A page about a root, flower, berry, peel, grain, or mushroom may use related vocabulary while still making a different culinary point.",
          "For that reason, do not collapse all ingredient forms into one generic entry. Let a recipe name the form it needs. Then use the flavor and preparation method to understand why that form was chosen. This approach is concrete, repeatable, and easier for English-language readers to carry from one page to the next."
        ]
      },
      {
        "title": "A useful way to take notes",
        "paragraphs": [
          "When you meet a new traditional phrase, record three things: the exact phrase, the ingredient or recipe beside it, and the kitchen image it brings to mind. For “Kidney Yang Deficiency,” the nearby idea to compare is **What Is Kidney Essence (Jing)? and Warming vs Cooling Foods**. A short note written in your own words is more valuable than copying a long definition.",
          "Over time, these notes reveal patterns. Some words stay close to season and climate imagery. Some are often placed beside flavor or ingredient form. Others help a reader follow how a classical text groups foods and herbs. The pattern becomes clearer through comparison, not through one isolated page."
        ]
      },
      {
    ...
    "references": [
      "HerbGuide. What Is Kidney Yang Deficiency?. https://herbguide.store/basics/what-is-kidney-yang-deficiency/",
      "Chinese Text Project. Huangdi Neijing. https://ctext.org/huangdi-neijing",
      "U.S. Food and Drug Administration. Questions & Answers on Improving the Safety of Spices. https://www.fda.gov/food/risk-and-safety-assessments-food/questions-answers-improving-safety-spices"
    ]
  },
...

  {
    ...
    "title": "What Does “Heart Yin Deficiency” Mean in Traditional Food Writing?",
    "description": "A plain-English guide to Heart Yin Deficiency in traditional food writing: a phrase combining Heart, Yin, and Deficiency read as cultural food-writing language.",
    "eyebrow": "Basics & Concepts",
    "intro": "“Heart Yin Deficiency” is a traditional phrase that combines Heart, Yin, and Deficiency. Its meaning sits within a historical vocabulary of paired concepts, and it should be read as cultural food-writing language rather than a modern label. Readers get the most value from the phrase when they separate its words, notice its setting, and then return to the concrete details of food: ingredient form, aroma, flavor, texture, and preparation.",
    "sections": [
      {
        "title": "Start with the phrase, not a personal label",
        "paragraphs": [
      ...
      },
      {
        ...
        "paragraphs": [
          "In this traditional vocabulary, **Heart** is a traditional network word with meanings broader than the anatomical organ. The word gains its full sense from the words around it, the type of text, and the recipe or ingredient description in which it appears.",
          "In this traditional vocabulary, **Yin** is a traditional contrast word used alongside yang and quieter imagery. The word gains its full sense from the words around it, the type of text, and the recipe or ingredient description in which it appears.",
          "In this traditional vocabulary, **Deficiency** is a contrast word that signals “less than” in a traditional text. The word gains its full sense from the words around it, the type of text, and the recipe or ingredient description in which it appears.",
          "When these words appear together, they create a layered expression. The goal is not to flatten that expression into a single modern word. The goal is to understand why a traditional writer selected these words rather than another nearby phrase."
        ]
      },
      {
        ...
        "bullets": [
          "Heart — A traditional network word with meanings broader than the anatomical organ — Read it as a word in a historical food-writing system, then look at ingredient form and recipe context",
          "Yin — A traditional contrast word used alongside yang and quieter imagery — Read it as a word in a historical food-writing system, then look at ingredient form and recipe context",
          "Deficiency — A contrast word that signals “less than” in a traditional text — Read it as a word in a historical food-writing system, then look at ingredient form and recipe context",
          "Surrounding words — The nearby vocabulary often changes the emphasis — Read the full phrase before drawing a kitchen connection",
          "Surrounding words — The nearby vocabulary often changes the emphasis — Read the full phrase before drawing a kitchen connection"
        ]
      },
      {
        "title": "Put the phrase back into kitchen context",
        "paragraphs": [
          "The clearest way to keep a traditional phrase grounded is to picture an actual kitchen scene. Think of a floral tea with a soft fruit note and a clear, quiet finish. This kind of image does not prove a single translation. Instead, it gives the reader a practical way to remember that classical vocabulary often moves between food, season, appearance, and preparation.",
          "On a recipe page, begin with the ingredients before the label. Notice whether the writer is using fresh or dried material, whether the method is a quick steep or a long simmer, and whether the recipe is built around aroma, flavor, color, or texture. Those concrete details are more useful than trying to make one phrase carry every meaning on its own."
        ]
      },
      {
        "title": "Notice the contrast words around it",
        "paragraphs": [
          "Traditional vocabulary often works through contrast. “Heart Yin Deficiency” becomes easier to read beside Heart Blood Deficiency and Yin–Yang language. This does not mean the terms are opposites in every sentence. It means the surrounding language helps readers understand what the writer is emphasizing.",
          "A good reading habit is to put two related pages side by side and underline the words that change. Look for changes in ingredient form, cooking method, season, aroma, and the traditional quality words placed next to an ingredient. This turns an unfamiliar phrase into a map of relationships rather than a memorization task."
        ]
      },
      {
        "title": "Ingredient form is part of the meaning",
        "paragraphs": [
          "Fragrance, color, and how an ingredient opens in water are more useful kitchen cues than a single abstract label. Traditional writing often pays close attention to those differences. A page about a root, flower, berry, peel, grain, or mushroom may use related vocabulary while still making a different culinary point.",
          "For that reason, do not collapse all ingredient forms into one generic entry. Let a recipe name the form it needs. Then use the flavor and preparation method to understand why that form was chosen. This approach is concrete, repeatable, and easier for English-language readers to carry from one page to the next."
        ]
      },
      {
        "title": "A useful way to take notes",
        "paragraphs": [
          "When you meet a new traditional phrase, record three things: the exact phrase, the ingredient or recipe beside it, and the kitchen image it brings to mind. For “Heart Yin Deficiency,” the nearby idea to compare is **What Does Shen Mean? and What Is Yin and Yang?**. A short note written in your own words is more valuable than copying a long definition.",
          "Over time, these notes reveal patterns. Some words stay close to season and climate imagery. Some are often placed beside flavor or ingredient form. Others help a reader follow how a classical text groups foods and herbs. The pattern becomes clearer through comparison, not through one isolated page."
        ]
      },
      {
    ...
    "references": [
      "HerbGuide. What Is Heart Yin Deficiency?. https://herbguide.store/basics/what-is-heart-yin-deficiency/",
      "Chinese Text Project. Huangdi Neijing. https://ctext.org/huangdi-neijing",
      "U.S. Food and Drug Administration. Questions & Answers on Improving the Safety of Spices. https://www.fda.gov/food/risk-and-safety-assessments-food/questions-answers-improving-safety-spices"
    ]
  },
  {
    ...
    "title": "What Does “Lung Qi Deficiency” Mean in Traditional Food Writing?",
    "description": "A plain-English guide to Lung Qi Deficiency in traditional food writing: a phrase combining Lung, Qi, and Deficiency as compact historical vocabulary.",
    "eyebrow": "Basics & Concepts",
    "intro": "“Lung Qi Deficiency” is a traditional phrase that combines Lung, Qi, and Deficiency. It is a compact piece of historical vocabulary that appears in food and herb writing; it is not a modern personal description. Readers get the most value from the phrase when they separate its words, notice its setting, and then return to the concrete details of food: ingredient form, aroma, flavor, texture, and preparation.",
    "sections": [
      {
        "title": "Start with the phrase, not a personal label",
        "paragraphs": [
      ...
      },
      {
        "title": "Break the wording into its parts",
        "paragraphs": [
          "In this traditional vocabulary, **Lung** is a traditional network word broader than an anatomical label. The word gains its full sense from the words around it, the type of text, and the recipe or ingredient description in which it appears.",
          "In this traditional vocabulary, **Qi** is a flexible traditional word often translated with ideas of movement, activity, or functional vitality. The word gains its full sense from the words around it, the type of text, and the recipe or ingredient description in which it appears.",
          "In this traditional vocabulary, **Deficiency** is a contrast word that signals “less than” in a traditional text. The word gains its full sense from the words around it, the type of text, and the recipe or ingredient description in which it appears.",
          "When these words appear together, they create a layered expression. The goal is not to flatten that expression into a single modern word. The goal is to understand why a traditional writer selected these words rather than another nearby phrase."
        ]
      },
      {
        ...
        "bullets": [
          "Lung — A traditional network word broader than an anatomical label — Read it as a word in a historical food-writing system, then look at ingredient form and recipe context",
          "Qi — A flexible traditional word often translated with ideas of movement, activity, or functional vitality — Read it as a word in a historical food-writing system, then look at ingredient form and recipe context",
          "Deficiency — A contrast word that signals “less than” in a traditional text — Read it as a word in a historical food-writing system, then look at ingredient form and recipe context",
          "Surrounding words — The nearby vocabulary often changes the emphasis — Read the full phrase before drawing a kitchen connection",
          "Surrounding words — The nearby vocabulary often changes the emphasis — Read the full phrase before drawing a kitchen connection"
        ]
      },
      {
        "title": "Put the phrase back into kitchen context",
        "paragraphs": [
          "The clearest way to keep a traditional phrase grounded is to picture an actual kitchen scene. Think of a light soup whose aroma comes from a few carefully chosen ingredients rather than a crowded pantry list. This kind of image does not prove a single translation. Instead, it gives the reader a practical way to remember that classical vocabulary often moves between food, season, appearance, and preparation.",
          "On a recipe page, begin with the ingredients before the label. Notice whether the writer is using fresh or dried material, whether the method is a quick steep or a long simmer, and whether the recipe is built around aroma, flavor, color, or texture. Those concrete details are more useful than trying to make one phrase carry every meaning on its own."
        ]
      },
      {
        "title": "Notice the contrast words around it",
        "paragraphs": [
          "Traditional vocabulary often works through contrast. “Lung Qi Deficiency” becomes easier to read beside Lung Yin Deficiency and basic Qi vocabulary. This does not mean the terms are opposites in every sentence. It means the surrounding language helps readers understand what the writer is emphasizing.",
          "A good reading habit is to put two related pages side by side and underline the words that change. Look for changes in ingredient form, cooking method, season, aroma, and the traditional quality words placed next to an ingredient. This turns an unfamiliar phrase into a map of relationships rather than a memorization task."
        ]
      },
      {
        "title": "Ingredient form is part of the meaning",
        "paragraphs": [
          "A recipe becomes easier to read when you notice whether the ingredient is fresh, dried, whole, sliced, or roasted. Traditional writing often pays close attention to those differences. A page about a root, flower, berry, peel, grain, or mushroom may use related vocabulary while still making a different culinary point.",
          "For that reason, do not collapse all ingredient forms into one generic entry. Let a recipe name the form it needs. Then use the flavor and preparation method to understand why that form was chosen. This approach is concrete, repeatable, and easier for English-language readers to carry from one page to the next."
        ]
      },
      {
        "title": "A useful way to take notes",
        "paragraphs": [
          "When you meet a new traditional phrase, record three things: the exact phrase, the ingredient or recipe beside it, and the kitchen image it brings to mind. For “Lung Qi Deficiency,” the nearby idea to compare is **What Is Lung Qi? and What Does Qi Mean?**. A short note written in your own words is more valuable than copying a long definition.",
          "Over time, these notes reveal patterns. Some words stay close to season and climate imagery. Some are often placed beside flavor or ingredient form. Others help a reader follow how a classical text groups foods and herbs. The pattern becomes clearer through comparison, not through one isolated page."
        ]
      },
      {
    ...
    "references": [
      "HerbGuide. What Is Lung Qi Deficiency?. https://herbguide.store/basics/what-is-lung-qi-deficiency/",
      "Chinese Text Project. Huangdi Neijing. https://ctext.org/huangdi-neijing",
      "U.S. Food and Drug Administration. Questions & Answers on Improving the Safety of Spices. https://www.fda.gov/food/risk-and-safety-assessments-food/questions-answers-improving-safety-spices"
    ]
  },

  {
    ...
    "title": "What Does “Kidney Yin Deficiency” Mean in Traditional Food Writing?",
    "description": "A plain-English guide to Kidney Yin Deficiency in traditional food writing: a phrase composed of Kidney, Yin, and Deficiency from a historical system.",
    "eyebrow": "Basics & Concepts",
    "intro": "“Kidney Yin Deficiency” is a traditional phrase composed of Kidney, Yin, and Deficiency. The wording belongs to a historical system of contrasts and relationships in traditional food writing, not to modern personal labeling. Readers get the most value from the phrase when they separate its words, notice its setting, and then return to the concrete details of food: ingredient form, aroma, flavor, texture, and preparation.",
    "sections": [
      {
        "title": "Start with the phrase, not a personal label",
        "paragraphs": [
      ...
      },
      {
        "title": "Break the wording into its parts",
        "paragraphs": [
          "In this traditional vocabulary, **Kidney** is a traditional network word broader than an anatomical organ. The word gains its full sense from the words around it, the type of text, and the recipe or ingredient description in which it appears.",
          "In this traditional vocabulary, **Yin** is a traditional contrast word used beside yang and quieter imagery. The word gains its full sense from the words around it, the type of text, and the recipe or ingredient description in which it appears.",
          "In this traditional vocabulary, **Deficiency** is a contrast word that signals “less than” inside a classical text. The word gains its full sense from the words around it, the type of text, and the recipe or ingredient description in which it appears.",
          "When these words appear together, they create a layered expression. The goal is not to flatten that expression into a single modern word. The goal is to understand why a traditional writer selected these words rather than another nearby phrase."
        ]
      },
      {
        ...
        "bullets": [
          "Kidney — A traditional network word broader than an anatomical organ — Read it as a word in a historical food-writing system, then look at ingredient form and recipe context",
          "Yin — A traditional contrast word used beside yang and quieter imagery — Read it as a word in a historical food-writing system, then look at ingredient form and recipe context",
          "Deficiency — A contrast word that signals “less than” inside a classical text — Read it as a word in a historical food-writing system, then look at ingredient form and recipe context",
          "Surrounding words — The nearby vocabulary often changes the emphasis — Read the full phrase before drawing a kitchen connection",
          "Surrounding words — The nearby vocabulary often changes the emphasis — Read the full phrase before drawing a kitchen connection"
        ]
      },
      {
        "title": "Put the phrase back into kitchen context",
        "paragraphs": [
          "The clearest way to keep a traditional phrase grounded is to picture an actual kitchen scene. Think of a pale fruit-and-grain bowl with gentle fragrance and a soft, glossy texture. This kind of image does not prove a single translation. Instead, it gives the reader a practical way to remember that classical vocabulary often moves between food, season, appearance, and preparation.",
          "On a recipe page, begin with the ingredients before the label. Notice whether the writer is using fresh or dried material, whether the method is a quick steep or a long simmer, and whether the recipe is built around aroma, flavor, color, or texture. Those concrete details are more useful than trying to make one phrase carry every meaning on its own."
        ]
      },
      {
        "title": "Notice the contrast words around it",
        "paragraphs": [
          "Traditional vocabulary often works through contrast. “Kidney Yin Deficiency” becomes easier to read beside Kidney Yang Deficiency and Yin–Yang language. This does not mean the terms are opposites in every sentence. It means the surrounding language helps readers understand what the writer is emphasizing.",
          "A good reading habit is to put two related pages side by side and underline the words that change. Look for changes in ingredient form, cooking method, season, aroma, and the traditional quality words placed next to an ingredient. This turns an unfamiliar phrase into a map of relationships rather than a memorization task."
        ]
      },
      {
        "title": "Ingredient form is part of the meaning",
        "paragraphs": [
          "A gentle texture, a bright aroma, and a long simmer are different culinary signals; they should not be collapsed into one label. Traditional writing often pays close attention to those differences. A page about a root, flower, berry, peel, grain, or mushroom may use related vocabulary while still making a different culinary point.",
          "For that reason, do not collapse all ingredient forms into one generic entry. Let a recipe name the form it needs. Then use the flavor and preparation method to understand why that form was chosen. This approach is concrete, repeatable, and easier for English-language readers to carry from one page to the next."
        ]
      },
      {
        "title": "A useful way to take notes",
        "paragraphs": [
          "When you meet a new traditional phrase, record three things: the exact phrase, the ingredient or recipe beside it, and the kitchen image it brings to mind. For “Kidney Yin Deficiency,” the nearby idea to compare is **What Is Kidney Essence (Jing)? and What Is Yin and Yang?**. A short note written in your own words is more valuable than copying a long definition.",
          "Over time, these notes reveal patterns. Some words stay close to season and climate imagery. Some are often placed beside flavor or ingredient form. Others help a reader follow how a classical text groups foods and herbs. The pattern becomes clearer through comparison, not through one isolated page."
        ]
      },
      {
    ...
    "references": [
      "HerbGuide. What Is Kidney Yin Deficiency?. https://herbguide.store/basics/what-is-kidney-yin-deficiency/",
      "Chinese Text Project. Huangdi Neijing. https://ctext.org/huangdi-neijing",
      "U.S. Food and Drug Administration. Questions & Answers on Improving the Safety of Spices. https://www.fda.gov/food/risk-and-safety-assessments-food/questions-answers-improving-safety-spices"
    ]
  },
...
,
  ...
  },
  {
    ...
    "description": "A light lavender tea recipe with culinary lavender and honey: a floral cup for a quiet kitchen routine with clear steps and serving notes.",
    "eyebrow": "Kitchen Traditions",
    "intro": "This food-first page turns culinary lavender and honey into a clear, beginner-friendly kitchen project. The goal is a balanced flavor, a practical method, and enough context to make the recipe feel approachable. It is written for readers who want a simple recipe before moving into ingredient profiles or traditional vocabulary. The result is a cup or bowl meant for everyday cooking, not a promise about a particular outcome.",
    "recipe": {
      "recipeYield": "2 cups or 2 small bowls",
      "prepTime": "PT10M",
      "totalTime": "PT35M",
      "ingredients": [
        "2 teaspoons to 1 tablespoon food-grade culinary lavender",
        "1 modest portion of honey",
        "3 cups fresh water or a mild, unsalted cooking base",
        "Optional: a small pinch of salt or a little sweetener, added only after tasting",
        "Optional garnish: a slice of citrus, a few sesame seeds, or a tender herb leaf"
      ],
      "steps": [
        "Check the ingredient. Use food-grade ingredients that smell clean and are stored dry. Rinse fresh produce if used.",
        "Build the base. Add the water or mild base to a small saucepan. Add culinary lavender and honey.",
        "Warm gently. Bring the liquid just to a simmer, then reduce the heat. For a tea-style preparation, cover and steep; for a bowl or broth, keep a quiet simmer.",
        "Taste before adjusting. After 10 minutes, taste a spoonful. Continue only if the flavor needs more time. Strong spices become dominant quickly.",
        "Strain or serve. Remove hard whole spices or woody pieces. Serve warm, or cool fully and refrigerate for a chilled version."
      ],
    ...
    "sections": [
      {
        "title": "A beginner-friendly kitchen structure",
        "paragraphs": [
          "A good first batch keeps the formula short: one lead ingredient, one supporting note, clean water or a simple base, and a measured cooking time. Here, culinary lavender provides the main character while honey keeps the flavor familiar. Taste near the end instead of adding extra ingredients all at once.",
          "In HerbGuide's kitchen writing, traditional food context is offered as a way to understand ingredients and pairings. It is not a personal label or a one-size-fits-all instruction."
        ]
      },
      {
      ...
      },
      {
        "title": "Why it works: Tradition meets science",
        "paragraphs": [
          "Culinary lavender is used sparingly in European kitchens — in teas, baked goods, and dessert syrups — for its floral, herbaceous scent. Paired with a little honey, it makes a quiet, gently sweet evening cup. On HerbGuide it is a pantry ingredient, not a treatment.",
          "Lavender's aroma comes mainly from linalool and linalyl acetate, the compounds behind its calming, floral character. Research has explored lavender, mostly as aromatherapy, for relaxation and mild anxiety, with preliminary and mixed results. Honey adds a familiar sweetness that rounds the herb's edge. The language stays culinary and descriptive."
        ]
      }
    ],
    "references": [
  ...
  },
  {
    ...
    "description": "A warm fennel tea recipe with fennel seeds and orange peel: a sweet anise seed infusion with clear steps and serving notes.",
    "eyebrow": "Kitchen Traditions",
    "intro": "This food-first page turns fennel seeds and orange peel into a clear, beginner-friendly kitchen project. The goal is a balanced flavor, a practical method, and enough context to make the recipe feel approachable. It is written for readers who want a simple recipe before moving into ingredient profiles or traditional vocabulary. The result is a cup or bowl meant for everyday cooking, not a promise about a particular outcome.",
    "recipe": {
      "recipeYield": "2 cups or 2 small bowls",
      "prepTime": "PT10M",
      "totalTime": "PT35M",
      "ingredients": [
        "2 teaspoons to 1 tablespoon food-grade fennel seeds",
        "1 modest portion of orange peel",
        "3 cups fresh water or a mild, unsalted cooking base",
        "Optional: a small pinch of salt or a little sweetener, added only after tasting",
        "Optional garnish: a slice of citrus, a few sesame seeds, or a tender herb leaf"
      ...
      "steps": [
        "Check the ingredient. Use food-grade ingredients that smell clean and are stored dry. Rinse fresh produce if used.",
        "Build the base. Add the water or mild base to a small saucepan. Add fennel seeds and orange peel.",
        "Warm gently. Bring the liquid just to a simmer, then reduce the heat. For a tea-style preparation, cover and steep; for a bowl or broth, keep a quiet simmer.",
        "Taste before adjusting. After 10 minutes, taste a spoonful. Continue only if the flavor needs more time. Strong spices become dominant quickly.",
        "Strain or serve. Remove hard whole spices or woody pieces. Serve warm, or cool fully and refrigerate for a chilled version."
      ],
    ...
    "sections": [
      {
        "title": "A beginner-friendly kitchen structure",
        "paragraphs": [
          "A good first batch keeps the formula short: one lead ingredient, one supporting note, clean water or a simple base, and a measured cooking time. Here, fennel seeds provides the main character while orange peel keeps the flavor familiar. Taste near the end instead of adding extra ingredients all at once.",
          "In HerbGuide's kitchen writing, traditional food context is offered as a way to understand ingredients and pairings. It is not a personal label or a one-size-fits-all instruction."
        ]
      },
      {
      ...
      },
      {
        "title": "Why it works: Tradition meets science",
        "paragraphs": [
          "Fennel seeds have a long place in Mediterranean and Indian kitchens, where they are often chewed or steeped after meals as a sweet, anise-scented digestive. Steeped with orange peel, the cup reads warm and aromatic rather than sharp. On HerbGuide it is pantry language, not a remedy.",
          "Fennel's anise character comes from anethole, the compound it shares with star anise; research has looked at fennel for digestive comfort and its mild antispasmodic, carminative reputation, though much of the evidence is preliminary. Orange peel adds citrus flavonoids. The framing stays food-first."
        ]
      }
    ],
    "references": [
  ...
  },
  {
    ...
    "description": "A toasted coriander seed tea recipe with coriander seeds and fresh ginger: a pantry infusion with clear steps and serving notes.",
    "eyebrow": "Kitchen Traditions",
    "intro": "This food-first page turns coriander seeds and fresh ginger into a clear, beginner-friendly kitchen project. The goal is a balanced flavor, a practical method, and enough context to make the recipe feel approachable. It is written for readers who want a simple recipe before moving into ingredient profiles or traditional vocabulary. The result is a cup or bowl meant for everyday cooking, not a promise about a particular outcome.",
    "recipe": {
      "recipeYield": "2 cups or 2 small bowls",
      "prepTime": "PT10M",
      "totalTime": "PT35M",
      "ingredients": [
        "2 teaspoons to 1 tablespoon food-grade coriander seeds",
        "1 modest portion of fresh ginger",
        "3 cups fresh water or a mild, unsalted cooking base",
        "Optional: a small pinch of salt or a little sweetener, added only after tasting",
        "Optional garnish: a slice of citrus, a few sesame seeds, or a tender herb leaf"
      ...
      "steps": [
        "Check the ingredient. Use food-grade ingredients that smell clean and are stored dry. Rinse fresh produce if used.",
        "Build the base. Add the water or mild base to a small saucepan. Add coriander seeds and fresh ginger.",
        "Warm gently. Bring the liquid just to a simmer, then reduce the heat. For a tea-style preparation, cover and steep; for a bowl or broth, keep a quiet simmer.",
        "Taste before adjusting. After 10 minutes, taste a spoonful. Continue only if the flavor needs more time. Strong spices become dominant quickly.",
        "Strain or serve. Remove hard whole spices or woody pieces. Serve warm, or cool fully and refrigerate for a chilled version."
      ],
    ...
    "sections": [
      {
        "title": "A beginner-friendly kitchen structure",
        "paragraphs": [
          "A good first batch keeps the formula short: one lead ingredient, one supporting note, clean water or a simple base, and a measured cooking time. Here, coriander seeds provides the main character while fresh ginger keeps the flavor familiar. Taste near the end instead of adding extra ingredients all at once.",
          "In HerbGuide's kitchen writing, traditional food context is offered as a way to understand ingredients and pairings. It is not a personal label or a one-size-fits-all instruction."
        ]
      },
      {
      ...
      },
      {
        "title": "Why it works: Tradition meets science",
        "paragraphs": [
          "Coriander seeds are a pantry staple in cuisines from India to the Americas, often dry-toasted to deepen their warm, citrusy-spice flavor before steeping. Paired with fresh ginger, the cup is bright and gently warming. On HerbGuide it is kitchen language, not medical advice.",
          "Coriander seed's character comes from linalool and other terpenes; preliminary research has looked at its antioxidant and digestive effects. Fresh ginger contributes gingerols, the compounds behind its warm, peppery bite. The page keeps these notes descriptive rather than prescriptive."
        ]
      }
    ],
    "references": [
  ...
  },
  {
    ...
    "description": "A fragrant cardamom tea recipe with green cardamom pods and black tea: a warm stovetop cup with clear steps and serving notes.",
    "eyebrow": "Kitchen Traditions",
    "intro": "This food-first page turns green cardamom pods and black tea into a clear, beginner-friendly kitchen project. The goal is a balanced flavor, a practical method, and enough context to make the recipe feel approachable. It is written for readers who want a simple recipe before moving into ingredient profiles or traditional vocabulary. The result is a cup or bowl meant for everyday cooking, not a promise about a particular outcome.",
    "recipe": {
      "recipeYield": "2 cups or 2 small bowls",
      "prepTime": "PT10M",
      "totalTime": "PT35M",
      "ingredients": [
        "2 teaspoons to 1 tablespoon food-grade green cardamom pods",
      ...
      "steps": [
        "Check the ingredient. Use food-grade ingredients that smell clean and are stored dry. Rinse fresh produce if used.",
        "Build the base. Add the water or mild base to a small saucepan. Add green cardamom pods and black tea.",
        "Warm gently. Bring the liquid just to a simmer, then reduce the heat. For a tea-style preparation, cover and steep; for a bowl or broth, keep a quiet simmer.",
        "Taste before adjusting. After 10 minutes, taste a spoonful. Continue only if the flavor needs more time. Strong spices become dominant quickly.",
        "Strain or serve. Remove hard whole spices or woody pieces. Serve warm, or cool fully and refrigerate for a chilled version."
      ],
    ...
    "sections": [
      ...
      },
      {
        "title": "Why it works: Tradition meets science",
        "paragraphs": [
          "Green cardamom pods are a hallmark of Indian chai and Middle Eastern coffee, valued for their sweet, eucalyptus-tinged warmth. Steeped with black tea, the cup becomes fragrant and mildly caffeinated. On HerbGuide it is a warming pantry drink, not a treatment.",
          "Cardamom's fragrance comes mainly from 1,8-cineole (eucalyptol) and related oils; research has looked at cardamom for digestive and antioxidant properties, mostly in preliminary studies. Black tea adds polyphenols and a modest amount of caffeine. The language stays food-first."
        ]
      }
    ],
    "references": [
      "Ashokkumar K, Murugan M, Dhanya MK, Warkentin TD. Botany, traditional uses, phytochemistry and biological activities of cardamom [Elettaria cardamomum (L.) Maton] – A critical review. Journal of Ethnopharmacology. 2020;246:112244.",
      "U.S. Department of Agriculture, Agricultural Research Service. FoodData Central. https://fdc.nal.usda.gov/",
      "U.S. Food and Drug Administration. Questions & Answers on Improving the Safety of Spices. https://www.fda.gov/food/risk-and-safety-assessments-food/questions-answers-improving-safety-spices",
      "National Center for Complementary and Integrative Health. Dietary and Herbal Supplements. https://www.nccih.nih.gov/health/dietary-and-herbal-supplements",
      "U.S. Food and Drug Administration. CPG Sec. 525.750: Spices—Definitions. https://www.fda.gov/regulatory-information/search-fda-guidance-documents/cpg-sec-525750-spices-definitions"
  ...
  },
  {
    ...
    "description": "A simple star anise tea recipe with star anise and tangerine peel: a whole-spice infusion with clear steps and serving notes.",
    "eyebrow": "Kitchen Traditions",
    "intro": "This food-first page turns star anise and tangerine peel into a clear, beginner-friendly kitchen project. The goal is a balanced flavor, a practical method, and enough context to make the recipe feel approachable. It is written for readers who want a simple recipe before moving into ingredient profiles or traditional vocabulary. The result is a cup or bowl meant for everyday cooking, not a promise about a particular outcome.",
    "recipe": {
      "recipeYield": "2 cups or 2 small bowls",
      "prepTime": "PT10M",
      "totalTime": "PT35M",
      "ingredients": [
        "2 teaspoons to 1 tablespoon food-grade star anise",
        "1 modest portion of tangerine peel",
        "3 cups fresh water or a mild, unsalted cooking base",
        "Optional: a small pinch of salt or a little sweetener, added only after tasting",
        "Optional garnish: a slice of citrus, a few sesame seeds, or a tender herb leaf"
      ],
      "steps": [
        "Check the ingredient. Use food-grade ingredients that smell clean and are stored dry. Rinse fresh produce if used.",
        "Build the base. Add the water or mild base to a small saucepan. Add star anise and tangerine peel.",
        "Warm gently. Bring the liquid just to a simmer, then reduce the heat. For a tea-style preparation, cover and steep; for a bowl or broth, keep a quiet simmer.",
        "Taste before adjusting. After 10 minutes, taste a spoonful. Continue only if the flavor needs more time. Strong spices become dominant quickly.",
        "Strain or serve. Remove hard whole spices or woody pieces. Serve warm, or cool fully and refrigerate for a chilled version."
      ],
    ...
    "sections": [
      {
        "title": "A beginner-friendly kitchen structure",
        "paragraphs": [
          "A good first batch keeps the formula short: one lead ingredient, one supporting note, clean water or a simple base, and a measured cooking time. Here, star anise provides the main character while tangerine peel keeps the flavor familiar. Taste near the end instead of adding extra ingredients all at once.",
          "In HerbGuide's kitchen writing, traditional food context is offered as a way to understand ingredients and pairings. It is not a personal label or a one-size-fits-all instruction."
        ]
      },
      {
      ...
      },
      {
        "title": "Why it works: Tradition meets science",
        "paragraphs": [
          "Star anise is a key spice in Chinese five-spice powder and slow-cooked broths, prized for its sweet, licorice-like warmth. Steeped whole with tangerine peel, it makes a fragrant, winter-friendly cup. On HerbGuide it is a whole-spice infusion, not a remedy.",
          "Star anise's anise note comes from anethole, the same compound found in fennel; research has studied star anise for antioxidant and antimicrobial activity. It is also an industrial source of shikimic acid, though the tea itself is simply a food. The page keeps the framing culinary and descriptive."
        ]
      }
    ],
    "references": [
