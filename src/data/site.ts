export const siteConfig = {
  ...
  title: "HerbGuide | Herb guides, tea recipes, and traditional terms in plain English",
  description:
    "Explore herb guides, tea recipes, kitchen pages, ingredient comparisons, and traditional terms explained in plain English for everyday readers.",
  newsletterTitle: "One clear herb guide each week",
  tagline: "Herb guides, tea recipes, and traditional terms in plain English.",
