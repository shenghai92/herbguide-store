...
const rawHerbs: Herb[] = [
  ...
  },
  {
    ...
    chinese: "玉米须",
    latin: "Zea mays",
    partUsed: "Dried styles and stigmas",
    category: "Tea herbs",
    commonNames: "yu mi xu, maize silk, corn stigma",
    arabicName: "Not standardized; use the botanical and Chinese name on the package.",
    summary: "Corn silk (Yu Mi Xu) is the dried styles and stigmas of the maize plant Zea mays, used as a gentle, cereal-like tea and infusion ingredient. This guide clarifies its botanical identity, traditional description, kitchen notes, research context, and safety boundaries.",
    whatItIs:
      "Corn silk refers to the dried styles and stigmas produced by the female flowers of Zea mays (maize). The fresh threads are pale to golden and become light, airy strands when harvested and dried for storage or infusion use; commercially, they are described as \"silks,\" \"styles,\" or \"corn stigma\" on ingredient lists. The plant Zea mays is globally cultivated as a cereal crop; many vernacular uses of its parts are tied to local culinary and household practices. Forms encountered in kitchens include cleaned and dried silks packaged as loose threads, and occasionally blended tea mixtures where corn silk is one ingredient among cereals and dried fruits.",
    nature: "Neutral",
    flavor: "Sweet, bland",
    channels: "Bladder, Liver, Gallbladder",
    traditionalUses: [
      "In historical herbal or materia medica systems, descriptors such as \"nature,\" \"flavor,\" and \"channels\" are shorthand categories used by practitioners to classify plants within a cultural pharmacopeia. These terms reflect conceptual frameworks developed in those traditions and are not modern anatomical maps or direct physiological assertions.",
      "Traditional texts that list corn silk use those categories to position the ingredient within a larger system of materia medica. In plain culinary terms, this indicates how practitioners historically categorized its perceived qualities — neutral \"temperature,\" a mild sweetness or blandness in taste, and associations with certain organ systems.",
      "Culturally, corn silk appears in regionally specific foodways where maize is a dietary staple. Its use as a warm infusion or as a mild, cereal-like addition to comforting preparations fits within a history of using available crop parts as both food and everyday household ingredients.",
    ],
    foodUses: [
      "Dried threads: silky, light texture; rehydrates quickly; store dry and airtight.",
      "Infusion / tea: mild, cereal-like flavor; blends well with neutral bases like warm water or barley.",
      "Blended mixes: subtle background note; check ingredient list for added herbs, fruits, or sweeteners.",
    ],
    caution:
      "Corn silk is commonly prepared as a gentle herbal infusion in food-scale contexts, but commercially marketed concentrated products and extracts are a separate category that may have different ingredient identities and potencies; consumers and cooks should consider them separately.",
    cautionDetails: [
      "Product identity and quality matter: choose food-grade material that is sourced for consumption and avoid silks from ornamental or chemically treated corn varieties.",
      "If you are taking medications prescribed by a health-care professional, are pregnant or nursing, or are planning a medical or dental procedure, seek guidance from a qualified health-care professional before considering concentrated botanical products.",
    ],
    scientificSections: [
      {
        title: "Research landscape",
        paragraphs: [
          "Scientific literature on Zea mays and its plant parts is extensive but heterogeneous: studies reference whole plant materials, food crops, individual phytochemical extracts, and commercial formulations. A PubMed search catalogues this diverse literature and is supplied here as a research-discovery tool, not as proof of consumer outcomes. Readers should expect variability in study quality, the plant material studied, and the processing methods used.",
        ],
      },
      {
        title: "Limits on generalizing across formats",
        paragraphs: [
          "Readers should note that laboratory and animal studies are part of the literature but cannot be automatically generalized to culinary use or to concentrated product formats. Public guidance documents emphasize the importance of distinguishing food-scale preparations from commercial concentrated products.",
        ],
      },
    ],
    references: [
      "[1] Royal Botanic Gardens, Kew. Plants of the World Online: Zea mays. https://powo.science.kew.org/results?q=Zea+mays",
      "[2] National Library of Medicine. PubMed search: Zea mays. https://pubmed.ncbi.nlm.nih.gov/?term=Zea+mays",
      "[3] NIH Office of Dietary Supplements. Botanical Dietary Supplements: Background Information. https://ods.od.nih.gov/factsheets/BotanicalBackground-Consumer/",
      "[4] NCCIH. Dietary and Herbal Supplements. https://www.nccih.nih.gov/health/dietary-and-herbal-supplements",
      "[5] U.S. Food and Drug Administration. Questions and Answers on Dietary Supplements. https://www.fda.gov/food/information-consumers-using-dietary-supplements/questions-and-answers-dietary-supplements",
    ],
    tags: ["corn silk", "yu mi xu", "maize silk", "corn stigma", "zea mays", "tea", "infusion"],
  },
  {
    slug: "gardenia-fruit",
    name: "Gardenia Fruit",
    ...
    partUsed: "Dried fruit",
    category: "Tea herbs",
    commonNames: "zhi zi, Cape jasmine fruit, gardenia fruit",
    arabicName: "Not standardized; use the botanical and Chinese name on the package.",
    summary: "Gardenia fruit (Zhi Zi) is the dried fruit of Gardenia jasminoides, valued for its warm golden-orange pigment and pronounced bitter profile. This guide clarifies its botanical identity, traditional description, kitchen context, research, and safety boundaries.",
    whatItIs:
      "Gardenia jasminoides is an evergreen shrub native to East and Southeast Asia; the dried mature fruit — often called zhi zi in Chinese sources — is harvested, dried, and traded as a botanical commodity. The commercial material is a ridged, capsule-like dried fruit that ranges in color from yellow-gold to brown and is commonly sold whole, sliced, or powdered for color and flavoring uses. Forms encountered in markets include whole dried capsules, crushed or powdered fruit, and standardized extracts in manufactured products. Culinary and traditional references distinguish the fruit from the ornamental flowers; the fruit is the plant part historically preserved for pigment and bitter-sour notes in food and materia medica lists.",
    nature: "Cold",
    flavor: "Bitter",
    channels: "Heart, Liver, Lung, Stomach",
    traditionalUses: [
      "Historical herbal literature classifies herbs using categories such as nature, flavor, and channel or meridian language. These are descriptive, symbolic frameworks from East Asian medical-philosophical traditions and should be read as traditional language rather than as a modern map of anatomy or clinical effect.",
      "In East Asian textual sources, gardenia fruit is listed among ingredients with a cold nature and a bitter taste; those descriptors function as part of a literate classification system for how an ingredient was thought to influence balance in classical narratives.",
      "Cultural uses historically emphasized the fruit's pigment and flavor more than sweetness. It appears in lists of materials used to color foods and textiles and as a bitter accent in certain preserved or ceremonial preparations.",
    ],
    foodUses: [
      "Whole dried fruit: ridged capsule, golden-brown pigment; can be steeped briefly for color in small-batch preparations.",
      "Powdered/ground: concentrated color, stronger bitter note; powder increases surface area and color release — use cautiously.",
      "Traditional preparation extract: intense pigment, concentrated bitterness; identify product type on the label and handle concentrated forms as specialist ingredients.",
    ],
    caution:
      "Gardenia fruit in food-scale use (for color or occasional flavoring) is different from concentrated preparations. Concentrated powders, extracts, or standardized formulations can have substantially higher levels of specific constituents than a culinary infusion, so product identity and quality information matter.",
    cautionDetails: [
      "Gardenia fruit is a concentrated, bitter botanical ingredient and differs from ornamental gardenia blossoms. Consider it a specialist pantry item rather than a casual tea base; concentrated formulations require an extra level of product literacy and professional guidance.",
      "If you are taking medications, are pregnant or nursing, or are planning a medical procedure, seek guidance from a qualified healthcare professional before considering concentrated botanical products.",
    ],
    scientificSections: [
      {
        title: "Research landscape",
        paragraphs: [
          "There is a body of basic research that examines individual chemical constituents found in gardenia fruit and related preparations. Those studies include laboratory-level analyses and early-stage experimental work on purified constituents; such literature serves as a map of compounds and hypotheses rather than as evidence that a given dried fruit product will produce comparable results in food or product use.",
        ],
      },
      {
        title: "Limits on generalizing across formats",
        paragraphs: [
          "Readers should note that the quality and type of sources vary widely: peer-reviewed chemistry papers, animal and in vitro research, and literature reviews each have a different evidentiary role. Systematic, human-centered product studies are less common, and findings from an extract or isolated compound are not automatically transferable to whole dried-fruit preparations or culinary uses.",
        ],
      },
    ],
    references: [
      "[1] Royal Botanic Gardens, Kew. Plants of the World Online: Gardenia jasminoides. https://powo.science.kew.org/results?q=Gardenia+jasminoides",
      "[2] Li Y, Li L, Hölscher C. Therapeutic Potential of Genipin in Central Neurodegenerative Diseases. CNS Drugs; 2016 Oct. PubMed PMID 27395402. https://pubmed.ncbi.nlm.nih.gov/27395402/",
      "[3] NIH Office of Dietary Supplements. Botanical Dietary Supplements: Background Information. https://ods.od.nih.gov/factsheets/BotanicalBackground-Consumer/",
      "[4] NCCIH. Dietary and Herbal Supplements. https://www.nccih.nih.gov/health/dietary-and-herbal-supplements",
      "[5] U.S. Food and Drug Administration. Questions and Answers on Dietary Supplements. https://www.fda.gov/food/information-consumers-using-dietary-supplements/questions-and-answers-dietary-supplements",
    ],
    tags: ["gardenia fruit", "zhi zi", "gardenia jasminoides", "cape jasmine fruit", "gardenia pigment", "bitter fruit", "tea herb"],
  },
  {
    slug: "cinnamon-bark",
    name: "Cinnamon Bark",
    ...
    partUsed: "Inner bark",
    category: "Warming herbs",
    commonNames: "rou gui, cassia bark, Chinese cinnamon",
    arabicName: "Not standardized; use the botanical and Chinese name on the package.",
    summary: "Cinnamon bark (Rou Gui) is the inner bark of Cinnamomum cassia, a bold, woody-sweet warming spice used in tea, braises, and poaching liquids. This guide clarifies its botanical identity, traditional description, kitchen notes, cassia-vs-Ceylon context, research, and safety boundaries.",
    whatItIs:
      "Cinnamomum cassia is a tree species whose inner bark is harvested, dried, and sold as the spice commonly called cassia or Chinese cinnamon. The market forms include whole quills (rolled bark), pieces, and ground powder; each form is intended for different culinary uses and label statements. Commercial cinnamon products may name the botanical, a colloquial term (cassia), or a geographic style (Chinese cinnamon); checking the botanical name helps identify the ingredient. In trade and botanical literature, cassia is distinct from Cinnamomum verum (often called Ceylon cinnamon). Those species differences are matters of plant identity, flavor profile, and composition — details that matter for cooks and label readers.",
    nature: "Hot",
    flavor: "Pungent, sweet",
    channels: "Kidney, Spleen, Heart, Liver",
    traditionalUses: [
      "Historical herb texts used sensory and elemental language — often translated as \"nature,\" \"flavor,\" and \"channels\" — to describe a substance's perceived qualities within a particular medical-philosophical system. These categories are cultural descriptors for classification and usage in those systems; they are not modern anatomical, diagnostic, or biomedical concepts.",
      "When classical East Asian texts describe rou gui as \"hot\" and \"pungent, sweet,\" they are naming sensory impressions and the herb's place within a traditional framework of classification. In that framework, such language directed how practitioners combined ingredients and prepared formulas.",
      "In culinary terms, the same historical notes help explain why cassia was chosen for warming stews, braises, and spiced beverages: its strong aroma and warming sensory character complement slow-cooked meats and spiced sweets.",
    ],
    foodUses: [
      "Whole quills (rolled inner bark): bold, woody-sweet, holds up to long simmering; use in braises, stocks, and poaching liquid where bark is removed before serving.",
      "Ground cassia: intense, quick-release aroma, more assertive than Ceylon powder; best for rubs, baking, and recipes requiring even flavor distribution.",
      "Broken bark pieces: perfumes liquids steadily without powdering dishes; handy for spiced teas and slow-cooked savory pots.",
    ],
    caution:
      "Culinary use of cinnamon bark in recipes is a different context from concentrated formulations sold as supplements or extracts. Food-scale use generally involves intermittent, small amounts compared with concentrated preparations, and those differences are material when considering safety and interactions.",
    cautionDetails: [
      "Product identity and label accuracy matter: cassia (Cinnamomum cassia) and Ceylon cinnamon (C. verum) are distinct ingredients with different compositions, so knowing which is on the label is important for consumers and cooks.",
      "If you take medication, are pregnant or nursing, or are planning a medical procedure, seek guidance from a qualified health professional before considering concentrated botanical products.",
    ],
    scientificSections: [
      {
        title: "Research landscape",
        paragraphs: [
          "Scientific literature on cinnamon includes laboratory work, animal studies, and clinical studies of different product types; quality and applicability vary greatly across those formats. A systematic review-style map of clinical literature is available and highlights the heterogeneity in product types and study designs. Because studies may use whole spice, powdered bark, or concentrated extracts, results for one format should not be assumed to apply to another.",
        ],
      },
      {
        title: "Limits on generalizing across formats",
        paragraphs: [
          "Research literacy matters: look for whether a study used identified botanical material, standardized extracts, or general culinary spice, and consider that preparation and product format affect composition. The NIH Office of Dietary Supplements and complementary bodies provide accessible overviews of how botanical research and product regulation differ from culinary use.",
        ],
      },
    ],
    references: [
      "[1] Royal Botanic Gardens, Kew. Plants of the World Online: Cinnamomum cassia. https://powo.science.kew.org/results?q=Cinnamomum+cassia",
      "[2] Leach MJ, Kumar S. Cinnamon for diabetes mellitus. The Cochrane Database of Systematic Reviews; 2012 Sep 12. PubMed PMID 22972104. https://pubmed.ncbi.nlm.nih.gov/22972104/",
      "[3] NIH Office of Dietary Supplements. Botanical Dietary Supplements: Background Information. https://ods.od.nih.gov/factsheets/BotanicalBackground-Consumer/",
      "[4] NCCIH. Dietary and Herbal Supplements. https://www.nccih.nih.gov/health/dietary-and-herbal-supplements",
      "[5] U.S. Food and Drug Administration. Questions and Answers on Dietary Supplements. https://www.fda.gov/food/information-consumers-using-dietary-supplements/questions-and-answers-dietary-supplements",
    ],
    tags: ["cinnamon bark", "rou gui", "cinnamomum cassia", "cassia bark", "chinese cinnamon", "warming spice", "tea", "braise"],
  },
  {
  ...
  },
  {
    ...
    partUsed: "Root",
    category: "Exterior-related herbs",
    commonNames: "jie geng, doraji, platycodon root",
    arabicName: "Not standardized; use the botanical and Chinese name on the package.",
    summary: "Balloon flower root (Jie Geng / doraji) is the taproot of Platycodon grandiflorus, used in Korean banchan and simmered soups for its firm, crisp bite and faint bitterness. This guide clarifies its botanical identity, traditional description, kitchen notes, research context, and safety boundaries.",
    whatItIs:
      "Balloon flower root is the edible taproot of Platycodon grandiflorus, a perennial plant native to East Asia and cultivated for both its blue-rayed flowers and its root. The root is sold fresh in markets, sliced and dried for storage, or processed into preserved formats; culinary names include doraji in Korean and jie geng in Chinese contexts. In culinary practice the root is handled differently depending on form: fresh roots are scrubbed, often boiled briefly, and seasoned or pickled as a banchan; dried slices appear in simmered soups and stocks where they soften and release flavor.",
    nature: "Neutral",
    flavor: "Bitter, pungent",
    channels: "Lung",
    traditionalUses: [
      "Historical herb texts use categories such as nature, flavor, and channels to describe how a plant was understood within a particular medical-philosophical framework. These terms are part of a pre-modern explanatory system used to guide classical practitioners and pharmacists; they are not a map of modern anatomy or a substitute for contemporary clinical methods.",
      "When older East Asian texts describe balloon flower root as \"neutral\" and \"bitter, pungent,\" they are using a concise system for comparing herbal materials: nature signals a relative energetic quality, while flavor names suggest sensory impressions and how the material was classified in recipes or compound formulas.",
      "For cooks and cultural readers, these traditional labels can be read as shorthand: the root's taste leans toward mild bitterness with aromatic notes, and it has long been cultivated and used in communities whose culinary and materia medica records overlap.",
    ],
    foodUses: [
      "Fresh root: firm, crisp, mildly starchy; scrub and slice, parboiling briefly to preserve crunchy texture in banchan.",
      "Dried slices: softer after simmering, concentrated vegetal flavor; rehydrate in simmering liquid and add to broths and stews.",
      "Pickled/seasoned banchan: tender-crisp, savory-tangy; commonly seasoned with sesame oil, soy, and aromatics.",
    ],
    caution:
      "Balloon flower root is used as a food ingredient in Korean cooking as well as in dried herbal formats; the page should not blur fresh culinary root, dried slices, and concentrated products. Food-scale culinary uses differ in formulation and concentration from laboratory-grade extracts or concentrated botanical supplements.",
    cautionDetails: [
      "Concentrated formulations and extracts can have properties that differ from whole-food culinary forms. Product identity, manufacturing quality, and stated ingredient lists should be checked on any commercial item.",
      "If you are taking medication, are pregnant or nursing, or are planning a medical procedure, seek guidance from a qualified health professional before considering concentrated botanical products.",
    ],
    scientificSections: [
      {
        title: "Research landscape",
        paragraphs: [
          "There is a body of literature examining Platycodon grandiflorus across phytochemistry, ethnopharmacology, and laboratory studies; a systematic review and ethnopharmacological map provides an organized entry point to that literature and highlights the diversity of study types and preparations. Research reports range from compositional profiles of isolated compounds to work on processed extracts.",
        ],
      },
      {
        title: "Limits on generalizing across formats",
        paragraphs: [
          "Because the experimental settings differ (whole food, herbal tea, dried slices, concentrated extracts, in vitro or animal models), findings from one preparation cannot automatically be generalized to another. Readers seeking deeper science should use the review as a literature map and check primary studies for preparation details, sample types, and study design.",
        ],
      },
    ],
    references: [
      "[1] Royal Botanic Gardens, Kew. Plants of the World Online: Platycodon grandiflorus. https://powo.science.kew.org/results?q=Platycodon+grandiflorus",
      "[2] Zhang L, Wang Y, Yang D. Platycodon grandiflorus - an ethnopharmacological, phytochemical and pharmacological review. Journal of Ethnopharmacology; 2015 Apr 22. PubMed PMID 25666431. https://pubmed.ncbi.nlm.nih.gov/25666431/",
      "[3] NIH Office of Dietary Supplements. Botanical Dietary Supplements: Background Information. https://ods.od.nih.gov/factsheets/BotanicalBackground-Consumer/",
      "[4] NCCIH. Dietary and Herbal Supplements. https://www.nccih.nih.gov/health/dietary-and-herbal-supplements",
      "[5] U.S. Food and Drug Administration. Questions and Answers on Dietary Supplements. https://www.fda.gov/food/information-consumers-using-dietary-supplements/questions-and-answers-dietary-supplements",
    ],
    tags: ["balloon flower root", "jie geng", "doraji", "platycodon grandiflorus", "platycodon root", "korean banchan", "soup"],
  },
  {
    slug: "fo-ti-root",
    name: "Fo-Ti Root",
    ...
    partUsed: "Prepared root tuber",
    category: "Kidney-related herbs",
    commonNames: "he shou wu, fo-ti, fleeceflower root",
    arabicName: "Not standardized; use the botanical and Chinese name on the package.",
    summary: "Fo-Ti root (He Shou Wu) is the prepared root tuber of Polygonum multiflorum, a specialty botanical with an unusually prominent safety boundary in modern literature. This guide clarifies its botanical identity, traditional description, kitchen context, research, and safety.",
    whatItIs:
      "Fo-Ti refers to the prepared (processed) tuberous root of Polygonum multiflorum, a species listed in modern botanical databases under that name or the synonym Fallopia multiflora. In commerce you will commonly see \"He Shou Wu\" on packages; authoritative plant lists confirm the botanical identity and synonymy. The product sold as Fo-Ti can be a dried prepared root, a powdered cut, or a processed extract depending on the manufacturer. Chemistry and laboratory literature identify constituents including anthraquinones such as emodin; these constituents appear in many laboratory and pharmacology reviews that survey the species' chemical profile.",
    nature: "Slightly warm",
    flavor: "Bitter, sweet, astringent",
    channels: "Liver, Kidney",
    traditionalUses: [
      "In classical East Asian herbal writing, descriptors such as \"nature,\" \"flavor,\" and \"channel\" are historical categories used to organize observations and analogies about herbs. These terms are part of a pre-modern system of classification and should be read as cultural-historical language rather than as a map of modern anatomy, physiology, or clinical effects.",
      "In traditional East Asian writings, Fo-Ti is described in terms that guided its use within multispecies formulas and culinary-herbal preparations. Those descriptions helped practitioners choose ingredients that corresponded to a recipe's overall character — warming versus cooling, bitter versus sweet — and to combine materials consistently.",
      "Translated into everyday culinary terms, Fo-Ti is best understood as a specialty preserved root ingredient: it has a particular set of preparation conventions and is seldom used the way common pantry roots are.",
    ],
    foodUses: [
      "Prepared dried root (cut): firm, woody root pieces for long infusion; check label for \"prepared\" or processing method.",
      "Powdered prepared root: fine powder for blending into ground herbal blends; requires careful label checks.",
      "Concentrated extract (commercial): laboratory-made concentrate, sometimes standardized; distinct from whole-root foods.",
    ],
    caution:
      "Fo-Ti requires an unusually prominent safety boundary in modern literature. Regulatory-quality reviews and case reports have identified liver-related adverse events associated with some Polygonum multiflorum products; NIH LiverTox documents published cases of serious liver injury linked to these products.",
    cautionDetails: [
      "Food-scale culinary use and concentrated commercial formulations are different product types. Concentrated extracts and standardized formulations can deliver much higher amounts of chemical constituents than a small culinary inclusion, and that difference matters for safety assessment.",
      "If you are taking medications, are pregnant, nursing, or planning an elective procedure, seek qualified professional guidance before considering concentrated botanical products.",
    ],
    scientificSections: [
      {
        title: "Research landscape",
        paragraphs: [
          "There is a body of literature addressing the chemical constituents and laboratory investigations of Polygonum multiflorum; reviews of compounds such as emodin summarize a variety of in-vitro and animal studies as well as pharmacokinetic research. The published studies are diverse in quality and focus, and many examine isolated compounds, extracts, or specific preparations rather than the whole dried root used in culinary contexts.",
        ],
      },
      {
        title: "Limits on generalizing across formats",
        paragraphs: [
          "Because study designs and product types differ — whole food, tea, dried root, and concentrated extract are not the same — findings from one format cannot be directly generalized to another without careful attention to how the material was prepared and tested.",
        ],
      },
    ],
    references: [
      "[1] Royal Botanic Gardens, Kew. Plants of the World Online: Polygonum multiflorum (syn. Fallopia multiflora). https://powo.science.kew.org/results?q=Polygonum+multiflorum",
      "[2] Dong X, Fu J, Yin X. Emodin: A Review of its Pharmacology, Toxicity and Pharmacokinetics. Phytotherapy Research; 2016 Aug. PubMed PMID 27188216. https://pubmed.ncbi.nlm.nih.gov/27188216/",
      "[3] NIH Office of Dietary Supplements. Botanical Dietary Supplements: Background Information. https://ods.od.nih.gov/factsheets/BotanicalBackground-Consumer/",
      "[4] NCCIH. Dietary and Herbal Supplements. https://www.nccih.nih.gov/health/dietary-and-herbal-supplements",
      "[5] U.S. Food and Drug Administration. Questions and Answers on Dietary Supplements. https://www.fda.gov/food/information-consumers-using-dietary-supplements/questions-and-answers-dietary-supplements",
      "[6] NIH LiverTox. Polygonum Multiflorum. https://www.ncbi.nlm.nih.gov/books/NBK548795/",
    ],
    tags: ["fo-ti root", "he shou wu", "polygonum multiflorum", "fleeceflower root", "prepared root tuber", "kidney herb", "safety"],
  },
  {
    slug: "barley-sprout",
    name: "Barley Sprout",
    ...
    partUsed: "Germinated grain",
    category: "Digestive herbs",
    commonNames: "mai ya, malted barley, barley malt",
    arabicName: "Not standardized; use the botanical and Chinese name on the package.",
    summary: "Barley sprout (Mai Ya) is the germinated grain of Hordeum vulgare, a pantry grain used in tea and congee for its toasted, mildly sweet cereal flavor. This guide clarifies its botanical identity, traditional description, kitchen notes, research context, and safety boundaries.",
    whatItIs:
      "Barley sprout, in the context of Mai Ya, refers to barley seeds that have been allowed to germinate to a point where the kernel's enzymes activate, and then are often dried or lightly roasted. The botanical species associated with these processed kernels is Hordeum vulgare. In pantry contexts the product may appear as dried germinated kernels, lightly roasted malted barley, or ground malted barley used as an ingredient in porridges and grain teas. Traditionally in East Asian sources, Mai Ya is a prepared grain product rather than a fresh sprout harvested as a vegetable. Modern packaged items labeled as barley sprout, barley malt, or barley grass can be different processes and should be read against the package label.",
    nature: "Neutral",
    flavor: "Sweet",
    channels: "Spleen, Stomach, Liver",
    traditionalUses: [
      "In historical herb and materia medica literature, short descriptive categories such as \"nature,\" \"flavor,\" and \"channel\" are used as shorthand to place a substance within a broader system of classification. These terms reflect historical observational frameworks and cultural medicine language; they do not map to modern anatomy or clinical physiology.",
      "When older Chinese sources refer to Mai Ya, they are speaking in a system that uses metaphorical and association language to group foods and substances for culinary and medical-philosophical practice. The categories above were ways for practitioners and cooks to describe how a pantry item fit into seasonal menus and digestion-related cooking advice.",
      "In practical cultural terms, Mai Ya appears as a prepared grain product used in congee (rice porridge) and simple grain teas across culinary traditions, valued for flavor, aroma, and the role it plays in the textural and sensory aspects of porridge.",
    ],
    foodUses: [
      "Lightly roasted/dried germinated barley: toasted grain aroma, mild sweetness; works well steeped as a grain tea or simmered into porridge.",
      "Ground malted barley: grainy, mildly sweet, fast-releasing flavor; useful as a mix-in for hot cereal or batter.",
      "Whole germinated kernels: softened texture after simmering, nutty notes; suitable for congee-style dishes.",
    ],
    caution:
      "Barley is a cereal grain that contains gluten; anyone with gluten-related concerns should avoid barley-containing products unless a qualified provider confirms they are appropriate. Distinguish between whole or lightly processed pantry forms and concentrated botanical extracts or isolated ingredients.",
    cautionDetails: [
      "\"Barley grass\" (harvested young leaf material), \"barley malt\" (processed for brewing or flavoring), and germinated barley kernels are different products with distinct processing histories; this page refers specifically to the germinated grain used in traditional pantry and congee contexts.",
      "If you are taking medication, are pregnant or nursing, or are planning a medical procedure, seek qualified professional guidance before considering concentrated botanical products derived from barley.",
    ],
    scientificSections: [
      {
        title: "Research landscape",
        paragraphs: [
          "There is a body of literature indexed under Hordeum vulgare that covers many forms of barley — whole grains, malted grain, extracts, and laboratory preparations — and a PubMed search serves as a discovery map rather than proof of any specific consumer effect. Studies vary in methods, populations, and the exact form of barley used; therefore findings from one product form should not be automatically generalized to another.",
        ],
      },
      {
        title: "Limits on generalizing across formats",
        paragraphs: [
          "Guidance from national offices on dietary supplements and botanical materials emphasizes careful attention to product identity, processing, and evidence quality when moving from bench science to consumer-facing language. Readers should note whether the material studied was a whole food, an extract, or a processed ingredient.",
        ],
      },
    ],
    references: [
      "[1] Royal Botanic Gardens, Kew. Plants of the World Online: Hordeum vulgare. https://powo.science.kew.org/results?q=Hordeum+vulgare",
      "[2] National Library of Medicine. PubMed search: Hordeum vulgare. https://pubmed.ncbi.nlm.nih.gov/?term=Hordeum+vulgare",
      "[3] NIH Office of Dietary Supplements. Botanical Dietary Supplements: Background Information. https://ods.od.nih.gov/factsheets/BotanicalBackground-Consumer/",
      "[4] NCCIH. Dietary and Herbal Supplements. https://www.nccih.nih.gov/health/dietary-and-herbal-supplements",
      "[5] U.S. Food and Drug Administration. Questions and Answers on Dietary Supplements. https://www.fda.gov/food/information-consumers-using-dietary-supplements/questions-and-answers-dietary-supplements",
    ],
    tags: ["barley sprout", "mai ya", "hordeum vulgare", "malted barley", "barley malt", "congee", "tea", "grain"],
  },
  {
    slug: "tangerine-peel",
    name: "Tangerine Peel",
    ...
    partUsed: "Peel",
    category: "Digestive herbs",
    commonNames: "ju pi, tangerine rind, mandarin peel",
    arabicName: "Not standardized; use the botanical and Chinese name on the package.",
    summary: "Tangerine peel (Ju Pi) is the dried outer rind of Citrus reticulata, a bright, bitter-orange aromatic used in tea, braises, and confections. This guide clarifies its botanical identity, traditional description, kitchen notes, peel comparison, research, and safety boundaries.",
    whatItIs:
      "Tangerine peel on this page refers to the dried outer rind of Citrus reticulata and closely related mandarins. The peel is separated from the fruit pulp and often sun-dried or gently heated to produce a shelf-stable botanical ingredient; commercial and traditional preparations vary by region and naming. In culinary and traditional contexts the peel is used as a dried aromatic — often torn, sliced, or shredded — to flavor teas, soups, braises, and confections. Supply forms include thin strips, small chips, or powdered peel; the sensory profile is driven by the outer colored flavedo layer, while inner pith levels affect bitterness and texture. Processing and age change flavor and handling characteristics, so label literacy is important for cooking and research interpretation.",
    nature: "Warm",
    flavor: "Pungent, bitter",
    channels: "Lung, Spleen",
    traditionalUses: [
      "Historical herb texts and classical materia medica often describe plant substances using relational categories such as nature, flavor, and channel language. These categories are part of a traditional classificatory language used to organize materia medica historically; they are not a map of modern anatomy, physiology, or clinical diagnosis.",
      "In plain culinary and cultural language, the traditional descriptors capture how cooks and herbalists historically experienced the peel: the rind feels warming in concept, has a sharp (pungent) and slightly bitter edge, and was associated with uses that align with certain recipe types and preservation methods.",
      "Historically assigned channels and natures were ways of grouping ingredients into usage patterns. For a modern reader that translates to simple practice notes: expect a peel that brightens and accents savory and stewed dishes and can bridge sweet and savory in pantries.",
    ],
    foodUses: [
      "Thin dried strips or chips: fragrant, bright citrus with a bitter edge; tear or simmer in liquid and remove before serving if texture is unwanted.",
      "Powdered peel: concentrated aromatic, easier to blend into dry rubs; use sparingly to avoid overpowering.",
      "Aged (chen pi) or processed peel: deeper, more mellow citrus notes; consider it a distinct pantry ingredient.",
    ],
    caution:
      "This page covers dried food-grade tangerine peel as commonly sold for culinary and cultural uses. Food-scale use of dried peel is a different category from concentrated formulations: essential oils, industrial extracts, and some standardized extracts are more concentrated and have different safety considerations.",
    cautionDetails: [
      "Fresh zest, candied peel, essential oil, and aged chen pi are distinct products with different preparation and handling methods; they should not be considered interchangeable. Essential oils are highly concentrated and require product-specific knowledge.",
      "People who are taking medication, are pregnant or nursing, or are planning a medical procedure should consult a qualified professional before considering concentrated botanical products.",
    ],
    scientificSections: [
      {
        title: "Research landscape",
        paragraphs: [
          "A body of literature addresses citrus byproducts, peel constituents, and processing effects, but study types vary widely in methods and goals. Laboratory, compositional, and food-science literature can be informative about phytochemical content and processing outcomes, while human-oriented research often focuses on specific formulations or uses.",
        ],
      },
      {
        title: "Limits on generalizing across formats",
        paragraphs: [
          "Because methods and product forms differ (whole dried peel, powders, extracts, and essential oils are not identical), results from one format cannot be directly generalized to another without careful qualification. Reviews can serve as methodological models for interpreting the variable quality and scope of published studies rather than as direct evidence for specific food or product claims.",
        ],
      },
    ],
    references: [
      "[1] Royal Botanic Gardens, Kew. Plants of the World Online: Citrus reticulata. https://powo.science.kew.org/results?q=Citrus+reticulata",
      "[2] Kamran U, Abbasi A, Tahir I. Can adjuncts to bowel preparation for colonoscopy improve patient experience and result in superior bowel cleanliness? A systematic review and meta-analysis. United European Gastroenterology Journal; 2020 Dec. PubMed PMID 32838693. https://pubmed.ncbi.nlm.nih.gov/32838693/",
      "[3] NIH Office of Dietary Supplements. Botanical Dietary Supplements: Background Information. https://ods.od.nih.gov/factsheets/BotanicalBackground-Consumer/",
      "[4] NCCIH. Dietary and Herbal Supplements. https://www.nccih.nih.gov/health/dietary-and-herbal-supplements",
      "[5] U.S. Food and Drug Administration. Questions and Answers on Dietary Supplements. https://www.fda.gov/food/information-consumers-using-dietary-supplements/questions-and-answers-dietary-supplements",
    ],
    tags: ["tangerine peel", "ju pi", "citrus reticulata", "mandarin peel", "tangerine rind", "tea", "braise"],
  },
  {
    ...
    chinese: "陈皮",
    latin: "Citrus reticulata",
    partUsed: "Aged dried peel",
    category: "Kitchen herbs",
    commonNames: "chen pi, aged tangerine peel, dried mandarin peel",
    arabicName: "Not standardized; use the botanical and Chinese name on the package.",
    summary: "Dried orange peel (Chen Pi) is the aged, dried peel of Citrus reticulata, prized for its rounded, mellowed citrus fragrance in tea, braises, and storage. This guide clarifies its botanical identity, traditional description, kitchen notes, research context, and safety boundaries.",
    whatItIs:
      "Chen Pi refers to the peel (pericarp) of Citrus reticulata that has been aged and dried; commercial and household preparations often come as strips, whole thin peels, or shreds intended for culinary use. In East Asian contexts, aging and sun-drying are standard processing steps that alter aroma and flavor, producing a darker, more aromatic peel than freshly zested rind or simply-dried fresh peel. The botanical source, Citrus reticulata, includes a number of mandarin and tangerine cultivars historically cultivated in China and neighboring regions. In food and specialty markets, Chen Pi is presented as an ingredient for scent and flavor as well as for cultural culinary uses; commercial labels sometimes indicate the length of aging or region of origin.",
    nature: "Warm",
    flavor: "Pungent, bitter",
    channels: "Lung, Spleen",
    traditionalUses: [
      "Historical East Asian herb texts describe materials using categories such as \"nature,\" \"flavor,\" and \"channels.\" These are traditional descriptive terms used to characterize how a dried material was perceived and categorized in pre-modern systems of classification; they are not direct mappings to modern anatomy, physiology, or biomedical diagnosis.",
      "In plain cultural and culinary language, the traditional descriptors point to how the ingredient is used in recipes rather than literal biological actions. Calling the peel \"warm\" and \"pungent\" reflects historic sensory categories — how it behaves in cooking and which preparations it complements.",
      "These traditional tags help modern cooks and readers understand why Chen Pi appears in certain regional preparations and preserved-food practices. They are useful as culturally specific shorthand for cooks and collectors but do not equate to modern medical claims.",
    ],
    foodUses: [
      "Whole aged peel (strips): rounded, layered citrus aroma with dry-resinous notes; rehydrate in hot liquid or add to slow-cooked dishes for gradual flavor release.",
      "Shredded/ready-to-steep: pronounced aroma, more surface area for infusion; handy for teas and braises.",
      "Powdered or ground: concentrated aroma, faster dispersal; useful for blending into spice rubs or baked goods.",
    ],
    caution:
      "Chen Pi, as presented here, refers to food-grade aged tangerine peel — the culinary pericarp that has been dried and aged — not to essential oils, industrial citrus flavorings, or generic \"orange\" flavored products. Concentrated formats (essential oils, extracts, or standardized fractions) are distinct from whole dried peel in concentration and handling characteristics.",
    cautionDetails: [
      "Food-scale use of aged peel in cooking is different from using concentrated botanical formulations. Product identity and quality matter: look for transparent sourcing, clear botanical names (Citrus reticulata), and processing descriptions on labels.",
      "If you use medications, are pregnant or nursing, or are planning a medical procedure, seek guidance from a qualified professional before considering concentrated botanical products.",
    ],
    scientificSections: [
      {
        title: "Research landscape",
        paragraphs: [
          "There is a body of literature that analyzes chemical constituents of Citrus reticulata peel and describes changes induced by processing such as aging, sun-drying, and treatments with vinegar or heat. One study maps how constituent profiles change before and after a vinegar-processing step, illustrating that processing alters the chemical fingerprint of the pericarp.",
        ],
      },
      {
        title: "Limits on generalizing across formats",
        paragraphs: [
          "The literature varies in quality, scale, and material type. Studies may examine whole dried peel, aqueous extracts, essential oils, or concentrated fractions; findings for one format do not automatically apply to other formats. For consumers and cooks, the important distinction is between food-scale preparations and concentrated extracts or isolated constituents.",
        ],
      },
    ],
    references: [
      "[1] Royal Botanic Gardens, Kew. Plants of the World Online: Citrus reticulata. https://powo.science.kew.org/results?q=Citrus+reticulata",
      "[2] Ruan JX, Su ZH, Liang YH. Discrimination of Chemical Constituents Changes of Citrus reticulata Pericarp Before and After Processing with Vinegar Based on Partial Least Squares-Discriminate Analysis. Zhong Yao Cai; 2016 Jan. PubMed PMID 30079706. https://pubmed.ncbi.nlm.nih.gov/30079706/",
      "[3] NIH Office of Dietary Supplements. Botanical Dietary Supplements: Background Information. https://ods.od.nih.gov/factsheets/BotanicalBackground-Consumer/",
      "[4] NCCIH. Dietary and Herbal Supplements. https://www.nccih.nih.gov/health/dietary-and-herbal-supplements",
      "[5] U.S. Food and Drug Administration. Questions and Answers on Dietary Supplements. https://www.fda.gov/food/information-consumers-using-dietary-supplements/questions-and-answers-dietary-supplements",
    ],
    tags: ["dried orange peel", "chen pi", "citrus reticulata", "aged tangerine peel", "dried mandarin peel", "tea", "braise"],
  },
  {
    slug: "amomum-fruit",
    name: "Amomum Fruit",
    ...
    partUsed: "Dried fruit",
    category: "Digestive herbs",
    commonNames: "sha ren, villous amomum, Chinese cardamom",
    arabicName: "Not standardized; use the botanical and Chinese name on the package.",
    summary: "Amomum fruit (Sha Ren) is the dried pod of Amomum villosum, a ginger-family aromatic used in soups, rice, and spice blends for its camphor-citrus cardamom note. This guide clarifies its botanical identity, traditional description, kitchen notes, research context, and safety boundaries.",
    whatItIs:
      "The material sold as Sha Ren is the dried fruit (the pod) of Amomum villosum, a species in the Zingiberaceae (ginger) family. The fruit matures into a small, ribbed capsule that contains aromatic seeds; the whole pod and its seeds are the marketplace forms used in culinary and traditional contexts. Common English names include villous amomum and Chinese cardamom. In trade and traditional texts, Sha Ren appears as whole pods, split pods, and occasionally as a ground powder; processing and labeling vary by source and market. Ethnobotanical and review literature map its historic uses and phytochemistry, and underline that form (whole fruit, crushed seeds, extract) matters for smell, flavor, and how a product is described in research reports.",
    nature: "Warm",
    flavor: "Pungent, aromatic",
    channels: "Spleen, Stomach, Kidney",
    traditionalUses: [
      "Historical herb lists and classical materia medica use short categorical words — often translated as nature, flavor, and channel — to communicate how a plant was used within a system of correspondences. Those categories are historical descriptive terms from classical texts, not modern anatomical, physiological, or diagnostic labels.",
      "In traditional East Asian materia medica, Sha Ren's short categorical labels point to its warming aromatic character and its use in digestive-related formulations within those systems of practice. Historical writers noted that Sha Ren is an aromatic, warming fruit commonly combined with grains and soups in traditional kitchens and apothecaries.",
      "Seen from a culinary and cultural perspective, Sha Ren occupies the niche of a small, assertive spice: the pods are added to rice, porridges, and slow-cooked broths to give a camphor-like, citrusy-cardamom note.",
    ],
    foodUses: [
      "Whole pod: mild, slowly releasing aroma; add whole pods early in cooking for subtle, sustained fragrance and remove before serving if desired.",
      "Crushed seeds: intense camphor-citrus-cardamom note; crack and add shortly before serving to preserve volatile aromatics.",
      "Ground powder: muted, quicker-to-integrate aroma; convenient but loses volatile top notes faster.",
    ],
    caution:
      "Culinary-scale use of Sha Ren as a spice — adding whole pods or crushed seeds to food — is distinct from using concentrated botanical products. Concentrated extracts, standardized supplements, or unfamiliar formulations can have different safety profiles and labeling considerations.",
    cautionDetails: [
      "Amomum is a specialty spice with several similarly named relatives and variable English labels in trade; accurate botanical identification (Amomum villosum versus other Amomum species) and clarity about the part used (dried fruit) matter for product quality and consumer expectations.",
      "If you use medications, are pregnant or nursing, or are planning a medical procedure, seek qualified professional guidance before considering concentrated botanical products.",
    ],
    scientificSections: [
      {
        title: "Research landscape",
        paragraphs: [
          "There is a body of academic literature describing the phytochemistry, traditional uses, and laboratory studies of Amomum villosum; the quality and focus of these sources vary widely, ranging from ethnobotanical surveys and phytochemical profiles to laboratory work summarized in modern reviews. Feng and colleagues (2024) provide a recent literature map that surveys ethnopharmacological accounts and phytochemical analyses across studies.",
        ],
      },
      {
        title: "Limits on generalizing across formats",
        paragraphs: [
          "When reviewing research, note that studies can involve whole fruit, teas, dried powders, or concentrated extracts, and results from one preparation type do not automatically generalize to others. Government resources on botanical dietary supplements discuss how product form, quality, and labeling affect interpretation of evidence and consumer safety.",
        ],
      },
    ],
    references: [
      "[1] Royal Botanic Gardens, Kew. Plants of the World Online: Amomum villosum. https://powo.science.kew.org/results?q=Amomum+villosum",
      "[2] Feng L, Wang Z, Lei Z. Amomum villosum Lour.: An insight into ethnopharmacological, phytochemical, and pharmacological overview. Journal of Ethnopharmacology; 2024 Dec 5. PubMed PMID 39069030. https://pubmed.ncbi.nlm.nih.gov/39069030/",
      "[3] NIH Office of Dietary Supplements. Botanical Dietary Supplements: Background Information. https://ods.od.nih.gov/factsheets/BotanicalBackground-Consumer/",
      "[4] NCCIH. Dietary and Herbal Supplements. https://www.nccih.nih.gov/health/dietary-and-herbal-supplements",
      "[5] U.S. Food and Drug Administration. Questions and Answers on Dietary Supplements. https://www.fda.gov/food/information-consumers-using-dietary-supplements/questions-and-answers-dietary-supplements",
    ],
    tags: ["amomum fruit", "sha ren", "amomum villosum", "chinese cardamom", "villous amomum", "soup", "rice", "spice"],
  },
  {
    slug: "safflower",
    name: "Safflower",
  ...
  },
  {
    ...
    partUsed: "Root",
    category: "Tea herbs",
    commonNames: "huang qin, Chinese skullcap root, baical skullcap",
    arabicName: "Not standardized; use the botanical and Chinese name on the package.",
    summary: "Skullcap root (Huang Qin) is the root of Scutellaria baicalensis, a bitter-tasting dried root with an important safety boundary in modern literature. This guide clarifies its botanical identity, traditional description, kitchen context, research, and safety.",
    whatItIs:
      "Skullcap root in this page refers to the root of Scutellaria baicalensis, known in Chinese as huang qin. The botanical name, species identity, and basic distribution are documented by major plant authorities; Kew's Plants of the World Online provides taxonomic confirmation and nomenclatural details. In traditional East Asian materia medica, the root is the primary plant part recorded for use. Forms encountered in supply chains include dried root slices (often referred to in trade as radix), powdered root, and various concentrated extracts used in commercial products. Modern commercial products may include single-ingredient preparations or multi-ingredient formulations whose content and concentration vary.",
    nature: "Cold",
    flavor: "Bitter",
    channels: "Lung, Stomach, Gallbladder, Large Intestine",
    traditionalUses: [
      "Historic herbal books use classificatory terms such as \"nature,\" \"flavor,\" and \"channels\" to situate an herb within a larger interpretive system. These labels are part of a cultural taxonomy developed over centuries and are not equivalent to modern anatomical or physiological maps.",
      "In historical Chinese herbal writing, descriptors like \"cold\" and \"bitter\" function as classification cues about how the herb was used in combination with others and what sensory qualities practitioners considered important. Translating that into plain culinary and cultural terms: huang qin is a bitter-tasting dried root that historically featured in specialist preparations rather than everyday cooking.",
      "Those classical categories guided herbal compilers in selecting combinations and preparation methods; they help explain why recipes or formulas paired this bitter root with particular plants or with certain cooking processes.",
    ],
    foodUses: [
      "Dried root slices: strong bitter note, woody texture; typically used in specialist traditional preparations.",
      "Powdered root: concentrated bitter flavor, convenient for blends; label literacy is important to confirm identity and purity.",
      "Extracts (commercial): highly concentrated; differ from a food ingredient and require extra attention to product identity.",
    ],
    caution:
      "There is an important distinction between using a botanical at a food scale and using concentrated commercial formulations. Product identity, standardization, and the presence of other ingredients matter for safety. Scutellaria baicalensis (Chinese skullcap, huang qin) is a different species from North American skullcap (Scutellaria lateriflora), and they are not interchangeable in supply chains or literature.",
    cautionDetails: [
      "Reports compiled by federal resources note instances of liver injury associated with some skullcap products, with complexity added by multi-ingredient formulations and potential issues of identity and adulteration. Because of that history, product quality and clear labeling are critical when encountering commercial extracts or blends.",
      "If you are taking medications, are pregnant or nursing, or are planning a medical procedure, seek guidance from a qualified healthcare professional before considering concentrated botanical products.",
    ],
    scientificSections: [
      {
        title: "Research landscape",
        paragraphs: [
          "There is an active research literature that examines constituents found in Scutellaria baicalensis and related preparations, and the quality and type of that literature vary. Systematic surveys and reviews map experimental studies, but laboratory and animal studies are not directly interchangeable with studies on whole food preparations, traditional decoctions, or commercial extracts.",
        ],
      },
      {
        title: "Limits on generalizing across formats",
        paragraphs: [
          "Readers should note that studies differ by format: some research examines isolated compounds, other work uses plant extracts, and still other investigations use different preparation methods. Because findings from one format cannot automatically be generalized to another, evaluate any paper's methods and the specific product or preparation under study.",
        ],
      },
    ],
    references: [
      "[1] Royal Botanic Gardens, Kew. Plants of the World Online: Scutellaria baicalensis. https://powo.science.kew.org/results?q=Scutellaria+baicalensis",
      "[2] Wen Y, Wang Y, Zhao C. The Pharmacological Efficacy of Baicalin in Inflammatory Diseases. International Journal of Molecular Sciences; 2023 May 26. PubMed PMID 37298268. https://pubmed.ncbi.nlm.nih.gov/37298268/",
      "[3] NIH Office of Dietary Supplements. Botanical Dietary Supplements: Background Information. https://ods.od.nih.gov/factsheets/BotanicalBackground-Consumer/",
      "[4] NCCIH. Dietary and Herbal Supplements. https://www.nccih.nih.gov/health/dietary-and-herbal-supplements",
      "[5] U.S. Food and Drug Administration. Questions and Answers on Dietary Supplements. https://www.fda.gov/food/information-consumers-using-dietary-supplements/questions-and-answers-dietary-supplements",
      "[6] NIH LiverTox. Skullcap. https://www.ncbi.nlm.nih.gov/books/NBK548757/",
    ],
    tags: ["skullcap root", "huang qin", "scutellaria baicalensis", "chinese skullcap root", "baical skullcap", "bitter root", "safety"],
  },
  {
    slug: "bupleurum-root",
    name: "Bupleurum Root",
    ...
    partUsed: "Root",
    category: "Movement herbs",
    commonNames: "chai hu, Chinese thoroughwax root, Bupleurum root",
    arabicName: "Not standardized; use the botanical and Chinese name on the package.",
    summary: "Bupleurum root (Chai Hu) is the dried root of Bupleurum chinense, a bitter-pungent aromatic root historically used in East Asian materia medica. This guide clarifies its botanical identity, traditional description, kitchen context, research, and safety boundaries.",
    whatItIs:
      "Bupleurum root refers to the dried root of plants in the genus Bupleurum, with Bupleurum chinense commonly cited in botanical and pharmacopoeial references. The plant is a member of the Apiaceae family and is recorded in global botanical databases for its taxonomic identity and distribution. In commercial and traditional contexts, the root is usually available as whole dried segments, slices, or processed extracts. Historically, chai hu appears in classical formulas as a component rather than a single-ingredient staple; modern commercial products may contain dried whole root, decoctions, or concentrated extracts, so label reading is important when comparing products or recipes.",
    nature: "Cool",
    flavor: "Bitter, pungent",
    channels: "Liver, Gallbladder, Pericardium, Triple Burner",
    traditionalUses: [
      "In historical herb writing, categories like nature, flavor, and channel are descriptive tools developed within a long textual tradition. These terms are not direct mappings onto modern anatomy, physiology, or diagnostic labels; they function as an internal vocabulary used to characterize herbs' sensory qualities and their roles within multi-ingredient compositions.",
      "Traditional descriptors such as \"cool,\" \"bitter,\" and \"pungent\" come from a classical framework for organizing plant medicines and their culinary-herbal roles. Read in plain language, chai hu is described historically as a cooling-flavored root with bitter and sharp notes.",
      "It is useful to think of these traditional categories as historical culinary labels rather than scientific claims about physiology. In everyday practice, chai hu has most often been included in mixtures where its aromatic and bitter-pungent character contributes to the overall flavor balance of a decoction.",
    ],
    foodUses: [
      "Whole dried root or slices: woody, aromatic, bitter-pungent; commonly simmered in multi-ingredient decoctions.",
      "Coarse cut for simmering: subtle bitter backbone, herbal aroma; steeped and strained, not typically used alone.",
      "Powdered or extract form: concentrated aromatic and flavor notes; label reading is essential.",
    ],
    caution:
      "Bupleurum is a specialist root that most commonly appears in multi-ingredient products and traditional compound preparations. Food-scale use of whole dried root differs substantially from concentrated formulations or extracts sold as commercial preparations.",
    cautionDetails: [
      "Government sources stress that botanical products vary in composition and that consumers should be attentive to labeling, standardized names, and product claims when evaluating supplements or extracts.",
      "For people taking medications prescribed by a healthcare professional, who are pregnant or nursing, or who are planning a medical procedure, it is important to consult a qualified health professional before considering concentrated botanical products.",
    ],
    scientificSections: [
      {
        title: "Research landscape",
        paragraphs: [
          "There is a peer-reviewed literature on Bupleurum-containing formulas and on extracts of Bupleurum species; however, the literature varies in quality, focus, and the specific product forms studied. Systematic reviews have examined clinical trials of certain multi-ingredient formulas that include Bupleurum, while laboratory and animal studies investigate chemical constituents and biological activities.",
        ],
      },
      {
        title: "Limits on generalizing across formats",
        paragraphs: [
          "A central point of research literacy is that findings from a laboratory experiment or an animal study do not automatically generalize to a whole-food preparation, a brewed decoction, or a concentrated extract. The species used, the plant part, extraction method, and the presence of other ingredients all affect how study results might relate to a kitchen or product context.",
        ],
      },
    ],
    references: [
      "[1] Royal Botanic Gardens, Kew. Plants of the World Online: Bupleurum chinense. https://powo.science.kew.org/results?q=Bupleurum+chinense",
      "[2] Yang L, Shergis JL, Di YM. Managing Depression with Bupleurum chinense Herbal Formula: A Systematic Review and Meta-Analysis of Randomized Controlled Trials. Journal of Alternative and Complementary Medicine; 2020 Jan. PubMed PMID 31328996. https://pubmed.ncbi.nlm.nih.gov/31328996/",
      "[3] NIH Office of Dietary Supplements. Botanical Dietary Supplements: Background Information. https://ods.od.nih.gov/factsheets/BotanicalBackground-Consumer/",
      "[4] NCCIH. Dietary and Herbal Supplements. https://www.nccih.nih.gov/health/dietary-and-herbal-supplements",
      "[5] U.S. Food and Drug Administration. Questions and Answers on Dietary Supplements. https://www.fda.gov/food/information-consumers-using-dietary-supplements/questions-and-answers-dietary-supplements",
    ],
    tags: ["bupleurum root", "chai hu", "bupleurum chinense", "chinese thoroughwax root", "aromatic root", "movement herb", "formula herb"],
  },
  {
    slug: "ginkgo-leaf",
    name: "Ginkgo Leaf",
    ...
    partUsed: "Leaf",
    category: "Exterior-related herbs",
    commonNames: "yin xing ye, maidenhair tree leaf, Ginkgo biloba leaf",
    arabicName: "Not standardized; use the botanical and Chinese name on the package.",
    summary: "Ginkgo leaf (Yin Xing Ye) is the leaf of Ginkgo biloba, a tree-leaf botanical primarily encountered in extract products with important safety and label-reading considerations. This guide clarifies its botanical identity, traditional description, research context, and safety boundaries.",
    whatItIs:
      "The part used here is the leaf of Ginkgo biloba. In commerce you will encounter whole dried leaf, leaf powders, and standardized extracts produced to defined ranges of characteristic constituents; the leaf is the starting botanical material for those extract processes. Ginkgo biloba is well documented in botanical references as the species name, and many modern product labels repeat that botanical name as the identity statement. Historically the tree has cultural significance in East Asia and has been cultivated for centuries; contemporary uses and product forms emerged more recently with the development of extract manufacturing and supplement markets.",
    nature: "Neutral",
    flavor: "Bitter, astringent",
    channels: "Heart, Lung",
    traditionalUses: [
      "Traditional herbal literature uses concise descriptors — nature, flavor, and channel language — to classify materials within a historical system of correspondences. These descriptors are historical terms for organizing materia medica and do not map onto modern anatomy, physiology, or biomedical diagnosis.",
      "In traditional Chinese-style classifications, ginkgo leaf is described using terms that reflect taste and symbolic pathways rather than specific biological mechanisms. Saying the leaf is \"bitter, astringent\" and associated with the Heart and Lung channels is part of a historical system that guided herbal combinations.",
      "Seen from a culinary and cultural angle, those descriptors can help explain why ginkgo leaf was historically combined with certain foods or other botanicals: taste qualities and making methods mattered. Modern readers can regard that traditional language as a historical lens on flavor, preparation, and pairing.",
    ],
    foodUses: [
      "Dried leaf: bitter, astringent when steeped; not a common kitchen herb in the U.S., so check label and form before assuming culinary interchangeability.",
      "Standardized extract: concentrated; read labels for standardized markers and origin.",
      "Seed / nut form: starchy, nutlike when processed traditionally, but fresh seeds are documented as toxic and are distinct from the leaf.",
    ],
    caution:
      "Food-scale uses — occasional culinary encounters with a dried leaf in a traditional preparation — are distinct from concentrated, manufactured formulations sold as extracts or supplements. Product identity, manufacturing quality, and standardization matter in risk and interaction profiles.",
    cautionDetails: [
      "Keep leaf, seed, and standardized extract clearly separate when reading labels or historic recipes. Fresh ginkgo seeds are documented as toxic and are considered distinct from leaf products; authoritative sources caution about seed toxicity and emphasize that extracts can interact with medicines and medical procedures.",
      "If you use medicines prescribed by a healthcare professional, are pregnant or nursing, or are planning a medical procedure, seek guidance from a qualified healthcare professional before considering concentrated botanical products.",
    ],
    scientificSections: [
      {
        title: "Research landscape",
        paragraphs: [
          "There is a substantial indexed literature on ginkgo, but studies vary widely in quality, methodology, and the specific product forms studied. Reviews and PubMed-indexed literature map a complex research history in which extracts, whole-leaf preparations, and other materials are not treated identically; readers should note which format a given paper addresses rather than generalizing across formats.",
        ],
      },
      {
        title: "Limits on generalizing across formats",
        paragraphs: [
          "Because lab and animal studies focus on mechanisms in controlled settings, they do not automatically predict effects for different product types in real-world use; regard the literature as a map of inquiry rather than a set of interchangeable product conclusions.",
        ],
      },
    ],
    references: [
      "[1] Royal Botanic Gardens, Kew. Plants of the World Online: Ginkgo biloba. https://powo.science.kew.org/results?q=Ginkgo+biloba",
      "[2] PubMed. Ginkgo. PubMed PMID 30000868. https://pubmed.ncbi.nlm.nih.gov/30000868/",
      "[3] NIH Office of Dietary Supplements. Botanical Dietary Supplements: Background Information. https://ods.od.nih.gov/factsheets/BotanicalBackground-Consumer/",
      "[4] NCCIH. Dietary and Herbal Supplements. https://www.nccih.nih.gov/health/dietary-and-herbal-supplements",
      "[5] U.S. Food and Drug Administration. Questions and Answers on Dietary Supplements. https://www.fda.gov/food/information-consumers-using-dietary-supplements/questions-and-answers-dietary-supplements",
      "[6] NCCIH. Ginkgo: Usefulness and Safety. https://www.nccih.nih.gov/health/ginkgo",
    ],
    tags: ["ginkgo leaf", "yin xing ye", "ginkgo biloba", "maidenhair tree leaf", "ginkgo extract", "safety", "label reading"],
  },
  {
    slug: "turmeric-root",
    name: "Turmeric Root",
    ...
    partUsed: "Rhizome",
    category: "Movement herbs",
    commonNames: "jiang huang, turmeric rhizome, Curcuma longa",
    arabicName: "Not standardized; use the botanical and Chinese name on the package.",
    summary: "Turmeric root (Jiang Huang) is the rhizome of Curcuma longa, a golden kitchen spice and traditional botanical with distinct culinary and supplement forms. This guide clarifies its botanical identity, traditional description, cooking notes, research context, and safety boundaries.",
    whatItIs:
      "Turmeric is the edible rhizome (underground stem) of Curcuma longa, a member of the ginger family (Zingiberaceae). The rhizome is harvested, cleaned, and used fresh, sliced, or dried and ground to produce the familiar golden-orange powder sold in spice aisles. The botanical name Curcuma longa and herb name Jiang Huang reflect long-standing use in South and Southeast Asia; commercial cultivation has since expanded to many tropical and subtropical regions. Forms in commerce include fresh rhizomes, sliced or whole dried rhizomes, ground turmeric powder, and standardized extracts or isolated curcuminoid preparations. Each form is materially different: the whole rhizome includes fiber, starches, and volatile oils in addition to curcuminoids, while extracts concentrate specific constituents.",
    nature: "Warm",
    flavor: "Pungent, bitter",
    channels: "Liver, Spleen",
    traditionalUses: [
      "Historical herbal traditions categorize plants using qualities that describe perceived effects and affinities rather than anatomical systems used in modern medicine. These categories — often labeled nature, flavor, and channel — are historical traditional language and should not be read as a modern anatomical map or clinical diagnosis.",
      "In traditional East Asian herb texts, turmeric's \"warm\" nature and \"pungent, bitter\" taste place it among roots and rhizomes used to influence circulation in culinary and materia medica lists. Those descriptions historically guided cooks and apothecaries about when and how to include the rhizome in complex formulas or seasonal foods.",
      "Seen through a kitchen lens, these traditional terms help explain why turmeric is commonly paired with warming spices, fats, and slow-cooked dishes that benefit from its color and assertive flavor.",
    ],
    foodUses: [
      "Fresh rhizome: bright, slightly resinous; earthy bitterness; grate or slice, handling with gloves to avoid staining.",
      "Dried slices / whole: concentrated aroma, more subtle than powder; rehydrate in broths or toast before crushing.",
      "Ground powder: deep golden color, warm, slightly bitter; bloom briefly in oil or fat to release color and rounded aroma.",
    ],
    caution:
      "Culinary turmeric — used as a spice in food — is materially different from concentrated curcuminoid extracts or high-bioavailability formulations. Whole rhizome and ground spice include a broad matrix of starches, oils, and fiber; concentrated products isolate or enhance specific constituents and may have different pharmacology and safety profiles.",
    cautionDetails: [
      "Supplements and extracts vary in manufacturing methods, standardization, and carrier ingredients; these differences affect how a product behaves and how it is discussed in the research literature. Read labels for botanical name, part used, and preparation type.",
      "If you take medication, are pregnant or nursing, or are planning a procedure, seek guidance from a qualified healthcare professional before considering concentrated botanical products. The NCCIH has reported cases where boosted-bioavailability curcumin formulations were associated with reports of liver harm.",
    ],
    scientificSections: [
      {
        title: "Research landscape",
        paragraphs: [
          "There is a substantial research literature on Curcuma longa and its constituents, and reviews map randomized and non-randomized trials, laboratory studies, and observational reports. Quality and product type vary: studies may use whole-plant preparations, dried powder, solvent extracts, or isolated curcuminoid formulations, and each material has distinct chemistry and behavior.",
        ],
      },
      {
        title: "Limits on generalizing across formats",
        paragraphs: [
          "A core reading skill is to match the product tested to the product you hold. Results from laboratory or animal work cannot be directly translated to effects in people or to culinary use; similarly, research on an enriched extract does not automatically apply to ground turmeric used as a spice.",
        ],
      },
    ],
    references: [
      "[1] Royal Botanic Gardens, Kew. Plants of the World Online: Curcuma longa. https://powo.science.kew.org/results?q=Curcuma+longa",
      "[2] Zeng L, Yang T, Yang K. Efficacy and Safety of Curcumin and Curcuma longa Extract in the Treatment of Arthritis: A Systematic Review and Meta-Analysis of Randomized Controlled Trial. Frontiers in Immunology; 2022. PubMed PMID 35935936. https://pubmed.ncbi.nlm.nih.gov/35935936/",
      "[3] NIH Office of Dietary Supplements. Botanical Dietary Supplements: Background Information. https://ods.od.nih.gov/factsheets/BotanicalBackground-Consumer/",
      "[4] NCCIH. Dietary and Herbal Supplements. https://www.nccih.nih.gov/health/dietary-and-herbal-supplements",
      "[5] U.S. Food and Drug Administration. Questions and Answers on Dietary Supplements. https://www.fda.gov/food/information-consumers-using-dietary-supplements/questions-and-answers-dietary-supplements",
      "[6] NCCIH. Turmeric: Usefulness and Safety. https://www.nccih.nih.gov/health/turmeric",
    ],
    tags: ["turmeric root", "jiang huang", "curcuma longa", "turmeric rhizome", "cooking spice", "curcumin", "golden root"],
  },
];
