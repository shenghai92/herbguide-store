...
const rawHerbs: Herb[] = [
  ...
  },
  {
    ...
    partUsed: "Root",
    category: "Blood-related herbs",
    summary: "A famous traditional root often searched by English name and best explained with careful context instead of hype.",
    whatItIs:
      "Dong quai is one of the most recognized traditional roots in English-language herb content, which makes it useful for search visibility but also easy to overstate without careful framing.",
    nature: "Warm",
    flavor: "Sweet, pungent",
